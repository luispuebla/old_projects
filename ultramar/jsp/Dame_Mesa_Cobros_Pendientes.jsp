...
%>	
<form name="form1" method="post" target="_self" action="Cobro_Venta_Pendiente.jsp">
	<br />
	
  <h1>Dame la Mesa para dejar Pendiente el Cobro</h1>
  	
  <br />
  <table width="504" height="293" border="1" align="center">
    <tr> 
