...
%>
<form name="form1" method="post" action="Cambio_BebidaS.jsp">
  <input type="hidden" name="area" value="<%= area1%>">
  <h1>Selecciona la Bebida para su Cambio</h1>
<table width="464" border="1">
      <th width="72"><div align="left">Bebida:</div></th>
      <td width="376" >
        <select name="bebida" onChange="MandaForma0(this.form)">
 <option selected value="0">Seleccione ...</option>
            <% 
			//System.out.println("6.1");
			ResultSet rs3 = beb.bebidasXDivision(division);
...
<% beb.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Selecciona_Division_BebidaCS.jsp" target="_self" 
