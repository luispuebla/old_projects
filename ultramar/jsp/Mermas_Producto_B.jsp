...
<form name="form1" method="post" action="Conf_Mermas_Producto_B.jsp">
  <input type="hidden" name="clave" value="<%= clave%>">
  <table align="center" border="1" width="485">
    <%
while(producto.next()){
%>
<input type="hidden" name="tip" value="<%=tipoTodo%>">
    <tr> 
      <th colspan="2"><div align="center"><%=clave+" --> "+producto.getString("nombre")%></div></th>
    </tr>
    <tr> 
      <th width="255"><div align="left">Mermas en Inventario Botella 1</div></th>
      <td width="214"><div align="center">
          <input type="text" size="7" maxlength="7" name="existenciaB1" value="0" onFocus="seleccionaTodo(this)" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) {event.returnValue = false;}">
          Botella 1</div></td>
    </tr>
    <tr> 
      <th width="255"><div align="left">Mermas en Inventario Botella 2</div></th>
      <td width="214"><div align="center">
          <input type="text" size="7" maxlength="7" name="existenciaB2" value="0" onFocus="seleccionaTodo(this)" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) {event.returnValue = false;}">
          Botella 2</div></td>
    </tr>
    <tr> 
      <th width="255"><div align="left">Mermas en Inventario Copeo</div></th>
      <td width="214"><div align="center">
          <input type="text" size="7" maxlength="7" name="existenciaC" value="0" onFocus="seleccionaTodo(this)" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) {event.returnValue = false;}">
          <%=tipoC%></div></td>
    </tr>
    <%
}
