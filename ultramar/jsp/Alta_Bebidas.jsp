...
<form name="form1" method="post" action="Conf_Alta_Bebidas.jsp">
...
mp.cierraConexion();
%>
<p><a href="Menu_Bebidas.jsp" target="mainFrame" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="152" height="36" border="0"></a></p>
