...
%>	
<h1>Por favor selecciona la Fecha para realizar la Factura Global:</h1>
<form name="form1" method="post" action="FacturaGlobal.jsp">
  <div align="center">
...
<p align="center"><a href="Menu_Facturas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="151" height="33" border="0"></a></p>
