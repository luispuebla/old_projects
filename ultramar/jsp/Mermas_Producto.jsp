...
<form name="form1" method="post" action="Conf_Mermas_Producto.jsp">
  ...
  <table align="center" border="1" width="419">
    <%
while(producto.next()){
...
%>
			<jsp:forward page="Mermas_Producto_B.jsp" />
...
<input type="hidden" name="tip" value="<%=tipoTodo%>">
    <tr> 
      <th colspan="2"><div align="center"><%=clave+" --> "+producto.getString("nombre")+tipoTodo%></div></th>
    </tr>
    <tr> 
      <th width="194"><div align="left">Mermas en Inventario</div></th>
