...
<%
	...
	if(area.equalsIgnoreCase("2")){
		existencia2 = request.getParameter("existencia2");
	}

	boolean resultado = false;

	int llenado = inv.valida_add(clave, existencia);
	
		if(llenado == 1) {
			resultado = inv.update_Producto_Inventario(clave, existencia, existencia2, area);
			if(resultado){
%>
