...
%>	
<form name="form1" method="post" target="_self" action="Cobro_Comanda_Pendiente.jsp">
	<br />
	
  <h1>Dame la Comanda para realizar su Cobro Pendiente</h1>
  	
  <br />
  <table width="102" height="83" border="1" align="center">
    <tr> 
      <td width="92" height="77"><div align="center"> 
          <p><font size="+2">Comanda:</font></p>
          <p> 
            <input name="comanda" type="text" size="15" maxlength="11">
          </p>
        </div></td>
    </tr>
  </table>
