...
%>
  <tr> 
    <td align="center"><div align="center"><a href="DetalleMateriaPrima.jsp?<%=rs.getString("clave")%>"><%= rs.getString("nombre")%></a></div></td>
...
<td width="280">
<p align="right"><a href="Menu_Materias_Primas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('regresar1','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="regresar1" width="152" height="36" border="0" id="regresar1"></a></p>
</td>
<td width="186">                                                                   <font color="#FFFFFF">------------------</font></td>
<form name="form1" method="post" action="ImprimirMaterias_Primas.jsp" target="_blank">
<td width="260">
