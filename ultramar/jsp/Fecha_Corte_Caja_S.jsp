...
%>	
<h1>Por favor selecciona el peri&oacute;do 
  de tiempo a realizar el corte de Caja:</h1>
<form name="form1" method="post" action="CorteDiarioS.jsp">
  <div align="center">
  ...
  <p align="center">
    <input type="submit" name="Submit" value="Enviar">
		...
		%>
        <div align="center"><a href="Menu_Ventas_Cash.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="151" height="33" border="0"></a></div>
		<%
		}
		else{%>
 <div align="center"><a href="Cortes_Caja.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="151" height="33" border="0"></a></div>
		<%
		}%>
