...
<html>
<head>
<title>Selecci&oacute;n Empleado / Periodo</title>
...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		if(calform.tipoConsul[0].checked){
			encontro = true;
			document.calform.action ="ConsumoXEmpleadoXTiempo.jsp";
		}
		else{
			var clave = document.calform.claveVendedor.value;
			if (clave.length == 0){
				alert("Debes especificar la clave del Empleado");
				document.calform.claveVendedor.focus();
			}		
			else{
				encontro = true;
				document.calform.action ="ConsumoXEmpleadoXTiempo.jsp";				
...
<body onLoad="setFecha()">
  <h1>Selecciona la consulta y lapso de tiempo para mostrar los consumos:</h1>
  ...
  <table align="center" border="1" width="450">
   <caption>Consulta por:</caption>
  	<tr>	
		...
		<th colspan="2"><div align="left"> Todos los Empleados Activos. </div></th>
    </tr>
      <tr> 
        <th><div align="center"> <input type="radio" name="tipoConsul"  value="vend" onClick="habilitaP(this.form)"></div></th>
		<th width="274"><div align="left"> Espec&iacute;fico, Clave de Empleado: </div></th>
		<td width="124"><div align="center"> <input type="text" name="claveVendedor" size="8" disabled maxlength="6" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) {event.returnValue = false;}; if(event.keyCode == 13){document.form1.Submit.click();}">
	    </div></td>
	</tr>
  </table>
  <br />
...
<p align="center"><font color="#FFFFFF"><a href="Menu_Personal.jsp" target="_self" 
