...
<p align="center">Llena todos los campos de la forma para dar de alta un Alimento:</p>
<form name="form1" method="post" action="Conf_Alta_AlimentosS.jsp">
...
<table width="724" border="1">
    <tr> 
      ...
      <td width="610"> $  <input name="precio" type="text" id="contacto" size="12" maxlength="11" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
        <span class="style1">**</span> </td>
    </tr>
    <tr> 
...
<%mp.cierraConexion();%>
<p><a href="Menu_AlimentosS.jsp" target="mainFrame" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="152" height="36" border="0"></a></p>
