...
<%
	...
	if(exis){ %>
		<b class="roj">El Alimento ya se encuentra Registrado en la Base de Datos</b>		
<p>&nbsp;</p>
<p><a href="Alta_AlimentosS.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
...
<p align="center"><img src="imagenes/barraN.jpg" width="532" height="82"></p>
	<%
		...
		int llenado = 0;
	llenado = ali.valida_add(nombre, m1, c1, precio, division);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = ali.add_Alimento( nombre, descripcion, m1, c1, m2, c2, m3, c3, m4, c4, m5, c5, m6, c6, m7, c7, m8, c8, m9, c9, m10, c10,precio, division);
		if(resultado){
%>
...
<p>&nbsp;</p>
<p><a href="Alta_Alimentos.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
<img src="imagenes/Regresar1.jpg" name="APadres" width="152" height="36" border="0"></a></p> 
<p align="center"><img src="imagenes/barraN.jpg" width="532" height="82"></p>
		<% 
		} 
