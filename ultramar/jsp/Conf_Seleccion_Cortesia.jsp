...
<%
	...
	if(cortesiatodos == null){
		System.out.println("No pidio cortesia");
	}
	else{
		todobien = ven.update_Cortesias(cortesiatodos,comanda);
	}
	if(todobien == 0){
%>
<h1>Se Actualizaron correctamente las Cortes&iacute;as </h1>
<% }
else{%>
<p>Existi&oacute; un problema al momento de Actualizar las Cortes&iacute;as. </h1>
<%}%>
