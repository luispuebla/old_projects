...
<html>
<head>
<title>Consulta de Compra por Recibir</title>
...
function setFecha(){
	...
	document.form1.anio.value=anioHoy;
}
...
<p><strong>Por favor selecciona el peri&oacute;do 
  de tiempo para buscar Compra por Recibir:</strong></p>
<form name="form1" method="post" action="Entregas_Ordenes_Compra.jsp">
  <div align="center">
    <table width="200">
      <tr> 
        <td> 
          <label> 
          <input type="radio" name="tipoConsul" value="dia" checked onClick="formatoDia(this.form)">
      ...
      <tr> 
        <td>
          <label> 
          <input type="radio" name="tipoConsul" value="semana" onClick="formatoSemana(this.form)">
      ...
      <tr> 
        <td> 
          <label> 
          <input type="radio" name="tipoConsul" value="mes" onClick="formatoMes(this.form)">
    ...
    <table width="23%" border="1">
      ...
      <tr> 
        <td >A&ntilde;o:</td>
        <td>
          <select name="anio" onChange="Checador(this.form)">
