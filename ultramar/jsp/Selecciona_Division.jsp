...
%>
<form name="form2" method="post" action="Selecciona_Division.jsp">
...
<form name="form1" method="post" action="Cambio_Division.jsp">
...
<% div.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Menu_Divisiones.jsp" target="_self" 
