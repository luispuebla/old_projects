...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		encontro = true;
		document.calform.action ="VentasXTiempoXMesera.jsp";				
	}
	return encontro;
}
...
<h1>Selecciona el lapso de tiempo y al Personal <br />
  para mostrar las Comandas:<br />
</h1>
<form name="calform" method="post" onSubmit="return OnSubmitForm()">
  <br />
 <table width="464" border="1">
      <th width="72"><div align="left">Personal:</div></th>
      <td width="376" >
        <select name="personal">
            <% 
			//System.out.println("6.1");
			ResultSet rs3 = per.dameMeseros();
			while(rs3.next()){
			//System.out.println("6.3");%>
            <option value="<%=rs3.getString("IDEmpleado")%>"><%=rs3.getString("NombreCompleto")%></option>
            <%}%>		
		</select>
   </td>
	</tr>
