...
<html>
<head>
<title>Muestra Consulta Comandas en un Tiempo por Mesera</title>
...
<%
	...
	String mesera = request.getParameter("personal");
	double toto = 0.0;
	String nombre = "";
	ResultSet mese = per.dameNombreMesera(mesera);
	while(mese.next()){
		nombre = mese.getString("NombreCompleto");
	}
	per.cierraConexion();
	//System.out.println(mesera);
%>
...
<table width="278" border="1" align="center">
  ...
  <%
  ResultSet rs = alCom.dameComandasXTiempoXMesera(fechaInicial,fechaFinal,mesera);
  while (rs.next()){
