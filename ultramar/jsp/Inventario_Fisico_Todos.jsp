...
%>
			<jsp:forward page="Inventario_Fisico_Todos_B.jsp" />
...
<% 
	...
	String tu = "";	
%>	
	<table width="619" align="center" cellpadding="0" cellspacing="0" border="1">
	<caption>INVENTARIO FÍSICO</caption>
	  <tr>
	  	<th width="81">Clave</th>
		<th width="363">Nombre</th>
		
    <th width="167">Cantidad</th>
	  </tr>
	 <p></p>
<%
	while (productos.next()){
	tipoU = productos.getInt("tipoA");
	if(tipoU == 1)
		tu = " --> Kg.";
	if(tipoU == 2)
		tu = " --> Unidades";
%>
      <tr>
		...
		<td><%=productos.getString("nombre")+tu%></td>
...
<form name="form1" method="post" action="ImprimirInventario_Fisico.jsp" target="_blank">
<td width="260">
