...
<p align="center">Realiza los Cambio deseados y da un clic en el Bot&oacute;n 
  Guardar:</p>
<form name="form1" method="post" action="Conf_Cambio_BebidaS.jsp">
...
<table width="724" border="1">
    <tr> 
	  ...
	  %>
          	<option value="<%=mp1.getString("clave")%>"><%=mp1.getString("nombre")%></option>
		<%		}	
			}
		%>
        </select>
...
<%mp.cierraConexion();%>
<p><a href="Selecciona_Division_BebidaCS.jsp" target="mainFrame" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="152" height="36" border="0"></a></p>
