...
//System.out.println("La unidad es: "+ArrayUnidad[i]);
		...
		String temporal = nomantes;
		temporal = temporal.substring(temporal.length()-1, temporal.length());
		String tipoTodo = "";
		String noharta = "";
		//System.out.println("Por favor1: "+temporal);
		if(temporal.equalsIgnoreCase("A")){
			tipoTodo = " --> Kg.";
			//System.out.println("Entre al A");
		}
		else if(temporal.equalsIgnoreCase("B")){
			tipoTodo = " --> Unidades";
			//System.out.println("Entre al b");
		}
		else if(temporal.equalsIgnoreCase("C")){
			tipoTodo = " --> Botella1";
			//System.out.println("Entre al c");
		}
		else if(temporal.equalsIgnoreCase("D")){
			tipoTodo = " --> Botella2";
			//System.out.println("Entre al d");
		}		
		nomantes = nomantes.substring(0, nomantes.length()-1);
		//System.out.println("Por favor2: "+nomantes);
		//System.out.println("Por favor: "+nomantes+tipoTodo);
		noharta = alCom.dameNombreProducto(nomantes);
%>
      <tr>
		<td><%=ArrayCantidad[i]%></td>
		<td><%=(noharta+tipoTodo)%></td>
