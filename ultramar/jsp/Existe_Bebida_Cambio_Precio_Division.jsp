...
<form name="form1" method="post" action="Cambio_Bebida_Precio_Division.jsp">
<table width="44%" border="0" align="center">
 ...
 <% div.cierraConexion();%>
<p align="center"><font color="#FFFFFF" face="Eras Medium ITC"><a href="Menu_Precios_Bebidas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regresar','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regresar" width="139" height="35" border="0"></a></font></p>
