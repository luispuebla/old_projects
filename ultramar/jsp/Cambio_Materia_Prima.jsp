...
<body onLoad="MM_preloadImages('imagenes/Regresar2.jpg'),Habilitador(document.form1)">
<%
...
<form name="form1" method="post" action="Conf_Cambio_Materia_Prima.jsp">   
...
<p align="center"><a href="Selecciona_Materia_Prima.jsp" onMouseOut="MM_swapImgRestore()" 
