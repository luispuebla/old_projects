...
<p>&nbsp;</p>
<p></p>
<form name="form1" method="post" action="Cambio_Alimento_Precio_Porcentaje_Division.jsp">
<h1>Introduce los datos para realizar los cambios en Precios:</h1> 
        <table width="30%" height="97" border="1" align="center">
          ...
          <select name="division">
            <% ResultSet rs = div.divisionesXArea("1");
		...
		while(rs.next()){%>
          ...
          <tr> 
            <th>Aumento:</td> 
            <td height="43"><input type="text" name="aumento" size="5" maxlength="3">
              %</td>
			  <tr> 
            <th>Decremento:</td> 
            <td height="43"><input type="text" name="decremento" size="5" maxlength="3">
              % </font> </td>
			  </tr>
        </table>
