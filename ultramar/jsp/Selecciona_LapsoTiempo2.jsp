...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		encontro = true;
		document.calform.action ="ComprasXProveedorFaltantes_Re.jsp";				
	}
	return encontro;
}
...
<%
		...
		if(claveProveedor.equals("$todos$")){
			claveProveedor = "%";
			nombreProveedor = "Todos los Proveedores Activos";
		}
%>	
...
<body onLoad="setFecha()">
  ...
  compras del proveedor:<br />
  <br /><%=nombreProveedor %></h1>
...
<%}%>
<p align="center"><font color="#FFFFFF"><a href="Escoge_Proveedor_Faltantes_Re.jsp" target="_self" 
