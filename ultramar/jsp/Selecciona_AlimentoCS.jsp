...
<html>
<head>
<title>Selecciona Alimento</title>
...
%>
<form name="form1" method="post" action="Cambio_AlimentoS.jsp">
  <input type="hidden" name="area" value="<%= area1%>">
  <h1>Selecciona el Alimento para su Cambio</h1>
<table width="464" border="1">
      <th width="80"><div align="left">Alimento:</div></th>
      <td width="468" >
        <select name="alimento" onChange="MandaForma0(this.form)">
 <option selected value="0">Seleccione ...</option>
            <% 
			//System.out.println("6.1");
			ResultSet rs3 = ali.alimentosXDivision(division);
...
<% ali.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Selecciona_Division_AlimentoCS.jsp" target="_self" 
