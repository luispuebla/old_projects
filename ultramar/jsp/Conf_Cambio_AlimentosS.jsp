...
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = ali.update_Alimento( clave, nombre, descripcion, m1, c1, m2, c2, m3, c3, m4, c4, m5, c5, m6, c6, m7, c7, m8, c8, m9, c9, m10, c10,precio, division);
		if(resultado){
%>
...
<p>&nbsp;</p>
<p><a href="Selecciona_Division_AlimentoCS.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
