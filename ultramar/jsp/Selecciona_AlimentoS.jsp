...
%>
<form name="form1" method="post" action="Baja_AlimentoS.jsp">
  <input type="hidden" name="area" value="<%= area1%>">
  <h1>Selecciona el Alimento a dar de Baja</h1>
...
<% ali.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Selecciona_Division_AlimentoS.jsp" target="_self" 
