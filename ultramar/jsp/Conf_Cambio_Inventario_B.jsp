...
<%
	...
	String[] invtodosB = (String[])request.getParameterValues("nuevaEB");
	String[] invtodosB2 = (String[])request.getParameterValues("nuevaEB2");
	String[] invtodosC = (String[])request.getParameterValues("nuevaEC");
	...
	for (int i=0;i<clavetodos.length;i++) {
		...
		if(!invtodosB[i].equalsIgnoreCase("") || !invtodosB2[i].equalsIgnoreCase("") || !invtodosC[i].equalsIgnoreCase("")){
			//System.out.println("adentro");
			todobien = todobien + inv.update_Inventarios_B(clavetodos[i],invtodosB[i],invtodosB2[i],invtodosC[i]);
		}
	}
	if(todobien == 0){
%>
