...
<html>
<head>
<title>Muestra Consulta Comandas en un Tiempo sin Cobrar</title>
...
<table width="404" border="1" align="center">
  <tr> 
    ...
    <th width="138">Fecha Alta</th>
    <th width="124">Total </th>
  </tr>
  <%
  ResultSet rs = alCom.dameComandasXTiempoSinCobrar(fechaInicial,fechaFinal);
  while (rs.next()){
	toto = toto + rs.getDouble("PT");
%>
  <tr> 
    <td><div align="center"><a href="DetalleComanda.jsp?<%=rs.getString("IDC")%>"><%=rs.getString("IDC")%></a></div></td>
    <td><div align="center"><%=rs.getString("FA")%></div></td>
