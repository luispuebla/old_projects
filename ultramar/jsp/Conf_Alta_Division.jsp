...
<%
	...
	boolean exis = true;
	exis = div.existe(nombre);
	
	if(exis){ %>
		<b class="roj">La División ya se encuentra Registrada en la Base de Datos</b>		
<p>&nbsp;</p>
<p><a href="Alta_Division.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
...
<p align="center"><img src="imagenes/barraN.jpg" width="532" height="82"></p>
	<%
		...
		int llenado = 0;
	llenado = div.valida_add(nombre, area);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = div.add_Division(nombre, area);
		if(resultado){
%>
