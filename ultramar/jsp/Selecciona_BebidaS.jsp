...
%>
<form name="form1" method="post" action="Baja_BebidaS.jsp">
  <input type="hidden" name="area" value="<%= area1%>">
  <h1>Selecciona la Bebida para dar de Baja</h1>
...
<% beb.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Selecciona_Division_BebidaS.jsp" target="_self" 
