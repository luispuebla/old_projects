...
%>
<h1>Escoge el Cobro Pendiente que deseas dar de Baja:</h1>
<p></p>
...
<form name="form1" method="post" action="Baja_Cobro_Pendiente.jsp">
<input type="hidden" name="comanda" value="<%=comanda%>">
 <table width="576" border="1" align="center">
  <caption>
    COBROS PENDIENTES COMANDA # <%=comanda%>
    </caption>
  <tr> 
    <td width="22"></th>
...
<%
	ResultSet rs = pa.dameCobros2(comanda);
	while(rs.next()){
	String fp = "";
