...
<form name="form1" method="post" action="Conf_Baja_AlimentoS.jsp">
...
//System.out.println("la clave que llego: "+clave);
 ...
 // System.out.println("Entro al vacio");
		out.print("Debes seleccionar un Alimento."); %>
  </font> 
  <%
}
else{
	String nombre = ali.dameNombreAlimento(alimento);
//System.out.println("Entro en la clave");
%>
  <h1>BAJA DE ALIMENTO </h1>
  ...
  <p><font> 
	...
	<%}%>
<p align="center"><font color="#FFFFFF"><a href="Selecciona_Division_AlimentoS.jsp" target="mainFrame" 
