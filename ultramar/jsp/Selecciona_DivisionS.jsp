...
%>
<form name="form2" method="post" action="Selecciona_DivisionS.jsp">
<h1>    Selecciona una Divisi&oacute;n para su Cambio 
</h1>
  <table width="286" border="1">
    <tr> 
      <th width="49"><div align="left">Área:</div></th>
      <td width="221">
  <select name="area" onChange="MandaSubmit(this.form)">
...
if(area1.equalsIgnoreCase("1"))
	nom = "Alimentos";
if(area1.equalsIgnoreCase("2"))
	nom = "Bebidas";
//muestra = true;
//System.out.println("El nombre es: "+nom);%>
    <option value="<%=area1%>"><%=nom%></option>
		<%	if(area1.equalsIgnoreCase("1")){%>
            <option value="2">Bebidas</option>
            <%}
			if(area1.equalsIgnoreCase("2")){%>		
...
<form name="form1" method="post" action="Cambio_DivisionS.jsp">
...
<% div.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Menu_DivisionesS.jsp" target="_self" 
