...
%>
<form name="form2" method="post" action="Selecciona_Materia_Prima.jsp">
...
<form name="form1" method="post" action="Cambio_Materia_Prima.jsp">
...
<% div.cierraConexion();%>
<p align="center"><font color="#FFFFFF"><a href="Menu_Materias_Primas.jsp" target="_self" 
