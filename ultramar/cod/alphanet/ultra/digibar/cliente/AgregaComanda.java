...
public class AgregaComanda extends JInternalFrame {

	private	JDesktopPane desktop = null;
	protected String mesaAlta;
	protected JComboBox jcComensal,  jcGenero, jcDivision;
	...
	private Font letraC, letraTH, letraT, letraD;
	private TableColumn column, column2;
	protected JLabel jlMesa, jlModifica, jlAgrega, jlElimina, jlNota, jlCancela, jlAceptar;
	private ImageIcon iiMesa, iiModifica, iiModificaP, iiAgrega, iiAgregaP, iiElimina, iiEliminaP, iiNota, iiNotaP,  iiBotonCanN, iiBotonCanP, iiBotonAceptarN,iiBotonAceptarP;
	private Sound son;
    ...
    public AgregaComanda() throws Exception {
        super("Agrega a Comanda", false, true, false);
	...
	public void despliegaInterfaz() throws Exception{
		...
		letraD=new Font("Eras Demin ITC",Font.BOLD,20);
		...
		url= getClass().getResource("/imas/fondoAltaComanda.jpg");
		...
		Vector <String> comensalListado = cliente.bs.listaComensales(mesaID);
		jcComensal = new JComboBox(comensalListado);
		jcComensal.setFont(letraC);
		jcComensal.setBounds(433,43,75,35);
...
//		final String[] columnNames = {"Cantidad", "Producto", "Tipo", "Precio"};
//		final Object[][] data = {};
		...
		column2.setCellRenderer( centerRenderer );
		column2.setPreferredWidth(69);
		column2.setMinWidth(69);
		column2.setMaxWidth(69);
		column2.setResizable(false);
		...
		column2.setResizable(false);
		column2 = jtSolicitado.getColumnModel().getColumn(5);
		column2.setCellRenderer( leftRender );
		column2.setPreferredWidth(209);
		column2.setMinWidth(209);
		column2.setMaxWidth(209);
		column2.setResizable(false);
	...
	public void procesoAceptar() {
		try{
			if(jtSolicitado.getRowCount() == 0){
				...
				ConfirmaComanda cc = new ConfirmaComanda();
				cc.setPadre(cliente);
				cc.setMesaTrabaja(mesaAlta);
				cc.setProductosSolicitdos(tmv.datos);
			...
			e.printStackTrace();
			JOptionPane.showInternalMessageDialog(cliente.desktop, "Excepcion  en AgregaComanda.\nVuelva a intentarlo.");
			Cierra();
		}
	}
...
//				System.out.println("La Nota: "+notaCorrespondiente);
				tmv.setValueAt(notaCorrespondiente, renglonGlobalSolicitado, 5);
//				tmv.actualizaDatos();
				jtSolicitado.clearSelection();
				renglonGlobalSolicitado = -1;
			}
	...
	public void procesoAgrega() throws Exception{
		if(renglonGlobalDisponible == -1){
			...
			String elComensal = (String)jcComensal.getSelectedItem();
			String laDivision = (String)jcDivision.getSelectedItem();
			...
			tmv.addRow(laCantidad, laClaveProducto,elComensal,elProducto,elTipo,"");
			jtDisponible.clearSelection();
			renglonGlobalDisponible = -1;
		}
	}
