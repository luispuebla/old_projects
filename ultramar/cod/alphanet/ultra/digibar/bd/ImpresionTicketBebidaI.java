...
public class ImpresionTicketBebidaI implements Printable {
    ...
    public ImpresionTicketBebidaI(int claveEmpleado) throws Exception {
...
//			System.out.println(query);
	...
	public void mandaImprimirAlimentos() throws Exception{
		rs = listadosBebidas(claveEmpleado);
		while(rs.next()){
			ContadorProductos ++;
			hayElementos = true;
