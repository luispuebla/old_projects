...
%>
<form name="form1" method="post" action="Conf_Baja_Ingreso.jsp">
...
<table width="650" border="1" align="center">
<%
	ResultSet rs = ban.dameIngresos(clave);
	int cont = 0;
	while(rs.next()){
%>
  <tr> 
...
%>
<p align="center"><a href="Baja_Ingreso.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="152" height="36" border="0"></a></p>
