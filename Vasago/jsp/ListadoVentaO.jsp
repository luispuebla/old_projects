...
<%
	...
	for (int i =1; i<=cantNumProductos; i++){
		...
		System.out.println("Llene con: "+request.getParameter("producto"+i));
...
%>
      <tr>
		<td><input type="radio" name="rg1" value="<%=productos.getString("claveProducto")%>"></td>
...
<%	System.out.println("retacho: "+ArrayProducto[i]);%>
