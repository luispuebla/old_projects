...
<%
	...
	boolean exis = true;
	exis = cliente.existe(rfc);
	
	if(exis){ %>
		<b class="roj">El Cliente ya se encuentra Registrado en la Base de Datos</b>		
<p>&nbsp;</p>
<p><a href="Alta_Clientes.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
...
<p align="center"><img src="imagenes/barraN.jpg" width="532" height="82"></p>
	<%
		...
		int llenado = 0;
	llenado = cliente.valida_add(rfc, nombre, direccion, colonia, delegacion, cp, ciudad);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = cliente.add_Cliente(rfc, nombre, direccion, colonia, delegacion, cp, ciudad, tipo, tel1, tel2, fax, email, diaCierran, horaComida, contacto, credito, pagoA, agente);
		if(resultado){
%>
