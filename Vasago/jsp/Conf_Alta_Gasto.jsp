...
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = ban.add_Gasto( banco, numero, concepto, importe, fecha);
		if(resultado){
%>
...
<p>&nbsp;</p>
<p><a href="Menu_Gastos.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
