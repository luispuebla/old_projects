...
%>
<h1>Escoge el Cliente al que pertenece la Venta </h1>
<p></p>
...
<form name="form1" method="post" action="Selecciona_LapsoTiempo3.jsp">
...
<table align="center" border="1" width="580">
  ...
  <td width="54"> <div align="center">
    ...
    <td width="374"><div align="left">CUALQUIER CLIENTE </div></td>
  </tr>

<%
	ResultSet rs = alVen.datosClientesActivos();
	while(rs.next()){
%>
  <tr> 
  <td width="54"> <div align="center">
