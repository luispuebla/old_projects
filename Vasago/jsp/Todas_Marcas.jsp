...
%>
<h1>Todos las Marcas registradas en Sistema son:</h1>
<table width="292" border="1" align="center">
  <tr bgcolor="#CCCCCC"> 
    <th width="86" ><div align="center">Clave</div></th>
    <th width="190" ><div align="center">Nombre</div></th>
  </tr>
<%	
		ResultSet rs = ma.dameMarcas();
		while (rs.next())
		{  
%>
  <tr> 
...
<td width="252">
<p align="right"><a href="Menu_Marcas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('regresar1','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="regresar1" width="152" height="36" border="0" id="regresar1"></a></p>
</td>
<td width="111">&nbsp;</td>
<form name="form1" method="post" action="ImprimirMarcas.jsp" target="_blank">
<td width="188">
