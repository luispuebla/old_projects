...
%>	
<p>&nbsp;</p>
<form name="form1" method="post" action="Selecciona_Producto_Inventario_Consulta.jsp">
<table width="628" border="0" align="center">
  <tr> 
    <th> <h1>Selecciona la L&iacute;nea del Producto para su Cambio en Inventario: </h1>
      </th>
  </tr>
  <tr>
  	<td><div align="center">
  ...
  <tr> 
    <th> <h1>Selecciona la Marca del Producto para su Cambio en Inventario: </h1>      </th>
  </tr>
  <tr>
  	<td><div align="center">
...
<p align="center"><a href="Consultas_Inventarios.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regresar','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regresar" width="152" height="36" border="0"></a></p>
