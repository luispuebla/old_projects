...
<html>
<head>
<title>Traspasos de Producto</title>
...
%>	
<p>&nbsp;</p>
<form name="form1" method="post" action="Selecciona_Producto_Traspasos.jsp">
<input type="hidden" name="tipop" value="<%=tipop%>">
<table width="628" border="0" align="center">
  <tr> 
    <th> <h1>Selecciona la L&iacute;nea del Producto para su Traspaso: </h1>
      </th>
  </tr>
  <tr>
  	<td><div align="center">
  ...
  <tr> 
    <th> <h1>Selecciona la Marca del Producto para su Traspaso: </h1>      </th>
  </tr>
  <tr>
  	<td><div align="center">
  	          <select name="marca" onChange="MandaForma1(this.form)">
			  <option value="0" selected>SELECCIONA..</option>
...
<p align="center"><a href="Tipo_Traslados_Inventario.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regresar','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regresar" width="152" height="36" border="0"></a></p>
