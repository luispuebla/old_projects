...
<html>
<head>
<title>Selección Cliente para la Entrega de Mercancia de la Venta</title>
...
%>
<h1>Escoge el Cliente al que pertenece la Entrega </h1>
<p></p>
...
<form name="form1" method="post" action="Escoge_Venta_Entrega.jsp">
