...
<form name="form1" method="post" action="Conf_Alta_Gasto.jsp">
<% 
...
<table width="762" border="1" align="center">
  <tr> 
	<th width="102" bgcolor="#CCCCCC">N&uacute;mero:</th>
	<td width="644"><input name="numero" type="text" id="numero" value="<%= rs.getString("numero") %>" size="30" maxlength="30" readonly="true"> 
	<b class="roj">**</b></td>
  </tr>
  <tr> 
	<th bgcolor="#CCCCCC">Banco:</th>
	<td><input name="banco" type="text" id="banco" value="<%= rs.getString("banco")%>" size="100" maxlength="100">
      <b class="roj">**</b></td>
  </tr>
  <tr> 
	<th width="102" bgcolor="#CCCCCC">Concepto :</th>
	<td width="644"> <input name="concepto" type="text" id="concepto" size="100" maxlength="100"></td>
  </tr>
  <tr> 
	<th width="102" bgcolor="#CCCCCC">Importe :</th>
	<td width="644"> $ <input name="importe" type="text" id="importe" size="15" maxlength="12">	</td>
  </tr>
  <tr> 
	<th width="102" bgcolor="#CCCCCC">Fecha :</th>
            <td width="190">
...
<p align="center"><a href="Alta_Gasto.jsp" onMouseOut="MM_swapImgRestore()" 
