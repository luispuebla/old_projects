...
%>
    <td><div align="center">$ <%= ban.formatoDinero(rs.getString("importe"))%></div></td>
	<td align="center">&nbsp;</td>
<%
	}else{
...
%>
  <tr> 
    ...
    <td><div align="center">$ <%= ban.formatoDinero(totalI+"")%></div></td>
    <td><div align="center">$ <%= ban.formatoDinero(totalG+"")%></div></td>
</tr>
</table>
</body>
</html>
