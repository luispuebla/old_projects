...
<jsp:useBean id="personalMain" class="com.vas.bd.ManagerPersonal" scope="page" />
...
<table width="433" border="1" align="center">
  ...
  <tr>
    ...
    <td><input name="contrase" type="text" maxlength="8" value="<%=laContra%>"></td>
  </tr>
  <tr>
    <th bgcolor="#DFE1EC">Confirmaci&oacute;n Contrase&ntilde;a:</th>
    <td><input name="contrase2" type="text" maxlength="8" value="<%=laContra%>"></td>
  </tr>  
  <tr>
