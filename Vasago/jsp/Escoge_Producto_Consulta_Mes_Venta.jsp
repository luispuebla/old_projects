...
<form name="form1" method="post" action="Producto_X_Mes_Venta.jsp">
...
<table width="650" border="1" align="center">
<%
	ResultSet rs = pro.todosLosProductos();
	while(rs.next()){
%>
  <tr> 
  <td width="39"> <div align="center">
    <input type="radio" name="clave" value="<%= rs.getString("ClaveProducto")%>" >
  </div></td>
    <td width="141"><div align="center"><%=rs.getString("ClaveProducto")%></div></td>
    <td width="448"><div align="left"><%=pro.descripcionProducto(rs.getString("ClaveProducto"))%></div></td>
  </tr>
<%
	}
	if(rs != null){
...
<p align="center"><a href="Consultas_Ventas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="152" height="36" border="0"></a></p>
