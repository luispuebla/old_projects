...
<jsp:useBean id="dia" class="com.vas.bd.CalculaDate" scope="page" />
<jsp:useBean id="prov" class="com.vas.bd.ManagerProveedores" scope="page" />
<jsp:useBean id="ti" class="com.vas.bd.TimeStamp" scope="page" />
...
%>	  
  ...
  <td></td>
    ...
    <td><div align="right">$ <%=pa.formatoDinero(tt+"")%></div></td>
  </tr>
</table>
