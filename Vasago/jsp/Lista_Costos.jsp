...
%>
 <table width="707" border="1" align="center">
  ...
  <tr> 
    ...
    <th width="489" bgcolor="#DFE1EC">Producto</th>
    <th width="98" bgcolor="#DFE1EC">Costo</th>
   </tr>
</table>
<p></p>
...
%>
  <tr> 
	...
	<td width="98"><div align="right">$ <%=pro.formatoDinero(rs.getString("costo"))%></div></td>
  </tr>
<%}
	if(rs != null){
		rs.close();
...
<td width="37">&nbsp;</td>
<td width="186">
<p align="center"><a href="Imprimir_Lista_Costos.jsp" onMouseOut="MM_swapImgRestore()" target="_blank"><img src="imagenes/Imprimir1.jpg" name="Retache" width="152" height="36" border="0"></a></p>
</td>
</tr>
</table>
