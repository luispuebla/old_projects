...
<!--
var valores_select_1 = new Array("Cobros", "Ventas");
var fila1 = new Array("Caja");
var fila2 = new Array("Agente");
var valores_select_2 = new Array(fila1, fila2);
...
<form name="form1" method="post" target="_self" action="Conf_Alta_Marca.jsp">
<br/>
 <h1>Alta Marca </h1>
  ...
  <tr>
    ...
    <td width="297"><input name="clave" type="text" size="5" maxlength="3"> 
      3 letras, por ejemplo: Sony --&gt; SON </td>
  </tr>
  <tr>
...
<table border="0" align="center" width="294">
  ...
  <p align="center"><a href="Menu_Marcas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" alt="Regresar" name="Regreso" width="152" height="36" border="0"></a>
    <br />
