...
var fila2 = new Array("Agente","Repartidor");
...
<br/>
 <h1>Alta Personal</h1>
  ...
  <tr>
    <th bgcolor="#DFE1EC">Clave del Usuario:</th>
    <td><input name="claveu" type="text" maxlength="8" value="<%=elUsuario%>"> (Max.8)</td>
  </tr>
  <tr>
    <th bgcolor="#DFE1EC">Contrase&ntilde;a asignada:</th>
    <td><input name="contrase" type="password" maxlength="8"> (Max.8)</td>
  </tr>
  <tr>
    <th bgcolor="#DFE1EC">Confirma Contrase&ntilde;a:</th>
    <td><input name="contrase2" type="password" maxlength="8"> (Max.8)</td>
  </tr>  
  <tr>
