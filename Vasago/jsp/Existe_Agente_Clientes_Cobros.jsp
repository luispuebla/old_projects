...
<html>
<head>
<title>Existencia de Agente</title>
...
%>	
<form name="form1" method="post" action="ClientesXAgenteCobros.jsp">
<p>&nbsp;</p>
<table width="650" border="0" align="center">
  <tr> 
    <th> <h1>Selecciona al Agente para mostrar sus Clientes: </h1></th>
  </tr>
    <tr> 
      <td> <div align="center">
        <select name="agente" id="agente" onChange="MandaForma(this.form)">
