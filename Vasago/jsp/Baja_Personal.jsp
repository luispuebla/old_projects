...
%>	
<form name="form1" method="post" target="_self" action="Conf_Baja_Personal.jsp">
  <p>&nbsp;</p>
  <h1>Baja del Personal.</h1>
  <p align="center">Escriba la Clave Del Personal.</p>
<table width="419" border="1" align="center">
  <tr>
      <td width="196" bgcolor="#DFE1EC">Clave del Usuario:</td>
