...
%>
 <table width="649" border="1" align="center" bordercolor="">
  ...
  <tr> 
    ...
    <th width="492" bgcolor="#DFE1EC" bordercolor="#000000">Producto</th>
    <th width="98" bgcolor="#DFE1EC" bordercolor="#000000">Precio 1</th>
	<th width="98" bgcolor="#DFE1EC" bordercolor="#000000">Precio 2</th>
	<th width="98" bgcolor="#DFE1EC" bordercolor="#000000">Precio 3</th>
	<th width="98" bgcolor="#DFE1EC" bordercolor="#000000">Precio 4</th>
	<th width="98" bgcolor="#DFE1EC" bordercolor="#000000">Precio 5</th>
   </tr>
</table>
<p></p>
...
%>
  <tr> 
	...
	<td width="98" bordercolor="#000000"><div align="right">$ <%=pro.formatoDinero(rs.getString("Precio1"))%></div></td>
	<td width="98" bordercolor="#000000"><div align="right">$ <%=pro.formatoDinero(rs.getString("Precio2"))%></div></td>
	<td width="98" bordercolor="#000000"><div align="right">$ <%=pro.formatoDinero(rs.getString("Precio3"))%></div></td>
	<td width="98" bordercolor="#000000"><div align="right">$ <%=pro.formatoDinero(rs.getString("Precio4"))%></div></td>
	<td width="98" bordercolor="#000000"><div align="right">$ <%=pro.formatoDinero(rs.getString("Precio5"))%></div></td>
  </tr>
<%}
	if(rs != null){
		rs.close();
