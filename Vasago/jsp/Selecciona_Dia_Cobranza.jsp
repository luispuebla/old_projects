...
<body onLoad="setFecha()">
  <h1>Selecciona el d&iacute;a para desplegar su cobranza correspondiente:</h1>
<form name="calform" method="post" target="_self" action="Despliega_Cobranza.jsp">
...
<p align="center"><a href="Consultas_Cobros.jsp" target="_self" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)"  onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="152" height="36" border="0"></a></p>
