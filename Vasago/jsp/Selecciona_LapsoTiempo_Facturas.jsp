...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		encontro = true;
		document.calform.action ="FacturasXTiempoXCliente.jsp";				
	}
	return encontro;
}
...
<p align="center"><a href="Consultas_Ventas.jsp" target="_self"  onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)" 
