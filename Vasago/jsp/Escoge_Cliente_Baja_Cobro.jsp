...
<html>
<head>
<title>Selección Cliente para su Cobro</title>
...
%>
<h1>Escoge el Cliente para la Baja del Cobro </h1>
<p></p>
...
<form name="form1" method="post" action="Escoge_Venta_Cobro_Baja.jsp">
