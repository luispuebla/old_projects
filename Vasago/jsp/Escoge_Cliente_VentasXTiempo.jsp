...
<html>
<head>
<title>Selección Cliente para sus Ventas</title>
...
%>
<h1>Escoge el Cliente al que pertenece las Ventas </h1>
<p></p>
...
<form name="form1" method="post" action="Selecciona_LapsoTiempo_Ventas.jsp">
