...
%>	
<p>&nbsp;</p>
<form name="form1" method="post" action="Selecciona_Cuenta_Fecha_Balance.jsp">
<table width="377" border="0" align="center">
  <tr> 
    <th width="448"> <h1>Selecciona el Banco al que pertenece la Cuenta para mostrar su Balance: </h1>
      </th>
  </tr>
  <tr>
  	<td><div align="center">
