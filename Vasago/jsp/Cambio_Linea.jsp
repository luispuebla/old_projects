...
<%
	...
	boolean exis = true;
	exis = li.existe(clave);
	
	if(exis){ %>

<form name="form1" method="post" action="Conf_Cambio_Linea.jsp">
<% 
	ResultSet rs = li.datos_Linea(clave);
	while (rs.next()) {
%>
...
<table width="274" border="1" align="center">
  <tr> 
	...
	<td width="159"><input type="text" name="clave" value="<%= rs.getString("clave") %>" readonly="true" size="5" maxlength="3"> 
	<b class="roj">**</b></td>
  </tr>
  <tr> 
...
<p> 
  <% }
	...
	li.cierraConexion();
 	...
 	<b class="roj">La Línea no se encuentra Registrada en el Sistema</b>	
<%
}
%>
</p>
<p align="center"><a href="Existe_Linea_Cambio.jsp" onMouseOut="MM_swapImgRestore()" 
