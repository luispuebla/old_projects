...
<jsp:useBean id="pa" class="com.vas.bd.ManagerPagos" />
...
%>
  <tr> 
	<th width="199" bgcolor="#CCCCCC">Total a Deber: </th>
	<td width="201"><div align="right">$ <%=pa.formatoDinero(pa.acortaLongitud(((totalD-yaPagado)+"")))%></div></td>
  </tr>	
</table>  

<form name="form1" method="post" action="Conf_Pago_Compra.jsp">
...
<input name="importe" type="text" size="12" maxlength="10" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"> </td>
  ...
  <tr> 
	<th width="150" bgcolor="#CCCCCC"><div align="center">Número de Cheque / Referencia</div></th>
            <td width="596"><input name="cheque" type="text" size="12" maxlength="11" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"> </td>
  </tr>
  <tr>
