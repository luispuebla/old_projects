...
//System.out.println("la clave que llego: "+clave);
 ...
 // System.out.println("Entro al vacio");
		out.print("Debes seleccionar un Producto."); %>
  </font> 
  <%
}
else{
...
%>
  ...
  <p><font>&iquest; Esta seguro de que desea eliminar el Producto: </font>
  <br/><font><%out.print(pro.descripcionProducto(clave));%> ?</font></p>
  <p><font> 
    <input type="submit" name="Submit" value="SI">
    </font> </p>
</form>
	<%}%>
<p align="center"><font color="#FFFFFF"><a href="Existe_Producto_Baja.jsp" target="mainFrame" 
