...
<td width="252">
<p align="right"><a href="Menu_Lineas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('regresar1','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="regresar1" width="152" height="36" border="0" id="regresar1"></a></p>
</td>
<td width="111">&nbsp;</td>
<form name="form1" method="post" action="ImprimirLineas.jsp" target="_blank">
<td width="188">
