...
<html>
<head>
<title>Selección de una Venta para su Entrega</title>
...
//System.out.println("Enicio");
   String cliente = request.getParameter("clave");%>
<%
//System.out.println("la clave que llego: "+cliente);
 if(cliente == null){%>
  <font>
  <%
...
%>
<h1>Escoge la Venta que corresponde a la Entrega:</h1>
<p></p>
...
<form name="form1" method="post" action="Entrega_Venta.jsp">
...
//System.out.println("voy a pedir las ventas");
	...
	ResultSet rs = en.todasLasVentasXClienteAgregada(cliente);
	while(rs.next()){
...
<%}%>
<p align="center"><a href="Escoge_Cliente_Venta_Entrega.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="152" height="36" border="0"></a></p>
