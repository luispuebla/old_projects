...
<%
	...
	if(exis){ %>
		<b class="roj">El Banco ya se encuentra Registrado en la Base de Datos</b>		
<p>&nbsp;</p>
...
<p align="center"><img src="imagenes/barraN.jpg" width="532" height="82"></p>
	<%
		...
		int llenado = 0;
	llenado = ban.valida_add(banco, numero, importe);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = ban.add_Banco( banco, numero, importe);
		if(resultado){
%>
