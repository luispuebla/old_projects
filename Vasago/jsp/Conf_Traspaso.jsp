...
<%
	...
	String bancoS = request.getParameter("bancoS");
	String bancoM = request.getParameter("bancoM");
	...
	int llenado = 0;
	llenado = ban.valida_add(bancoS, bancoM, importe);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		resultado = ban.Traspaso( bancoS, bancoM, importe);
		if(resultado){
%>
		<jsp:forward page="Menu_Bancos.jsp" />
<% 
		}
		else{  %>
		<b class="roj">Ocurrio un Error al Guardar en la Base de Datos</b>		
<p>&nbsp;</p>
<p><a href="Menu_Bancos.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
