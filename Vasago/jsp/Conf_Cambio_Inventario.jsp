...
<%
	...
	String[] existenteR = (String[])request.getParameterValues("existenteR");	
	String[] invrtodos = (String[])request.getParameterValues("nuevaER");
	String[] existencia = (String[])request.getParameterValues("existencia");
	int todobien = 0;
	todobien = inv.update_Inventarios(clavetodos,existencia,invtodos, existenteR, invrtodos, usuario);
	if(todobien == 0){
%>
