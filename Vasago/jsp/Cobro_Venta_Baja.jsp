...
<html>
<head>
<title>Selección de Cobro para la Baja</title>
...
<%
	ResultSet rs = co.dameCobrosVenta(ClaveVenta);
	while(rs.next()){
%>
  <tr> 
  <td width="35"> <div align="center">
    ...
    <td width="240"><div align="center"><%=rs.getString("fechaCobro")%></div></td>
    <td width="125"><div align="right">$ <%=co.formatoDinero(rs.getString("monto"))%></div></td>
  </tr>
<%
	}
	if(rs != null){
