...
<%
	...
	int llenado = 0;
	llenado = pa.valida_add(fecha,importe,formaPago);
//System.out.println("agente 1 "+agente);
	if (llenado==1){
		if(pa.valida_Total(ClaveOrden,total,importe)){
			resultado = pa.add_Pago( ClaveOrden, proveedor, fecha, importe, formaPago, cheque, banco,total);
			if(resultado){
%>
...
%>	
	<b class="roj">El Monto dado sobre pasa el total de Pago al Proveedor</b>	
