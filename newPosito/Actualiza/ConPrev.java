...
/**
* La clase "ConPrev" es la responsable de hacer la conexión a la base de datos, en esta se especifican las firmas con las que se tendrá acceso a la BD.
...
/**
* El constructor de la clase ConPrev emplea un archivo a partir del cual se obtendra la dirección del archivo jdbc para tener acceso (driver), el nombre de usuario, y su contraseña, para finalmente lograr la Conexion.
*/
	public ConPrev( ){
		try{
