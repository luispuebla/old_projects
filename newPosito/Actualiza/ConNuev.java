...
/**
* La clase "ConNuev" es la responsable de hacer la conexión a la base de datos, en esta se especifican las firmas con las que se tendrá acceso a la BD.
...
public class ConNuev{

	public Connection miConnection;

/**
* El constructor de la clase ConNuev emplea un archivo a partir del cual se obtendra la dirección del archivo jdbc para tener acceso (driver), el nombre de usuario, y su contraseña, para finalmente lograr la Conexion.
*/
	public ConNuev( ){
		try{
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			String dburl = "jdbc:mysql://localhost/newRetono";
			String dbuser = "root";
