...
// NUEVAS CLASES ACTUALIZADAS..
	...
	public synchronized ResultSet dameListadoTicketsFac (String ticket1, String ticket2, String ticket3, String ticket4, String ticket5, String formatoFac) throws SQLException, Exception{
  	  Statement st = null;
  	  ResultSet rs= null;
	  ...
	  if(con != null){
		 try{
			 String query = "";
			 if(formatoFac.equals("1")){
				 query = "SELECT SUM(contenidoticket.cantidadProducto) AS cantidadProducto, productos.descripcion, productos.gravaIVA, contenidoticket.precioVenta, SUM(contenidoticket.precioAPagar) AS precioAPagar, contenidoticket.tipoVenta  FROM contenidoticket, productos WHERE "+complementoQuery +" AND productos.ID_Pro = contenidoticket.ID_Pro AND contenidoticket.estatusTicket = 1 AND contenidoticket.estatusPago != 0 GROUP BY contenidoticket.ID_Pro,contenidoticket.tipoPrecio,contenidoticket.tipoVenta,contenidoticket.precioVenta ORDER BY contenidoticket.horaRegistro,contenidoticket.fechaRegistro";
			 }
			 else{
				query = "SELECT contenidoticket.cantidadProducto AS cantidadProducto, productos.descripcion, productos.gravaIVA, contenidoticket.precioVenta, contenidoticket.precioAPagar AS precioAPagar, contenidoticket.tipoVenta  FROM contenidoticket, productos WHERE "+complementoQuery +" AND productos.ID_Pro = contenidoticket.ID_Pro AND contenidoticket.estatusTicket = 1 AND contenidoticket.estatusPago != 0 ORDER BY contenidoticket.numTicket,contenidoticket.horaRegistro";
			 }
