...
<html>
<head>
<title>Consulta de por Fechas Corte Caja</title>
...
<h1>Por favor selecciona el peri&oacute;do de tiempo a mostrar la Cancelacion de Ticket:</h1>
<form name="form1" method="post" action="Baja_Despliega_Consulta.jsp">
  <div align="center">
    <table width="300">
      <tr> 
        <th><div align="left"> <label> <input type="radio" name="tipoCon" value="dia" onClick="formatoDia(this.form)"> Consulta Por D&iacute;a</label> </div></th>
      </tr>
      <tr> 
        <th><div align="left"><label> <input type="radio" name="tipoCon" value="mes" onClick="formatoMes(this.form)">  Consulta Mensual</label></div></th>
	  </tr>
		<tr>
        <th><div align="left"><label> <input type="radio" name="tipoCon" value="total" checked onClick="formatoDia(this.form)">  Todas las Cancelaciones Existentes</label></div></th>
      </tr>
    </table>
<br />	
