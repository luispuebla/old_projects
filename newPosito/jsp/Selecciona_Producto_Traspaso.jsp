...
function funcionFoco(){
	document.form2.elProducto.focus();
}
...
%>
<form name="form2" method="post" action="Inventario_Traspaso.jsp">
	<input type="hidden" name="tipoT" value="<%=tipoT%>">
	<h1>Escribe la clave del producto para solicitar su traspaso: </h1>
	<table width="500" align="center" border="1">
		<tr>
			<th>Clave:</th>
			<td><div align="center">
			  <input type="text" name="elProducto" maxlength="6" size="8" onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;">
			  </div></td>
		</tr>
	</table>
...
<h1>O bien seleccione de la siguiente lista el producto para su traspaso:</h1>
<form name="form0" method="post" action="Selecciona_Producto_Traspaso.jsp">
	<input type="hidden" name="tipoT" value="<%=tipoT%>">
...
<form name="form1" method="post" action="Inventario_Traspaso.jsp">
	<input type="hidden" name="tipoT" value="<%=tipoT%>">
...
%>			
		<tr>
			<td><div align="center">
			  <input type="radio" name="elProducto" value="<%=rs.getString("ID_Pro")%>">
			  </div></td>
			<% if(formatoBusqueda.equalsIgnoreCase("1")){ %>
