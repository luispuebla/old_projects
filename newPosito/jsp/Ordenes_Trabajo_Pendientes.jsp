...
<html>
<head>
<title>Muestra Consulta Ordenes de Trabajo Pendientes</title>
...
<%
	...
	ResultSet pendien = alProd.dameOrdenesPendientes();
%>
<p>
...
%>
  <tr> 
    <td><div align="center"><a href="DetalleOrdenPendiente.jsp?<%=pendien.getString("clave")%>"><%=pendien.getString("clave")%></a></div></td>
    <td><div align="center"><%=pendien.getString("fechaAlta")%></div></td>
    <td><div align="center">&nbsp;<%=pendien.getString("ObsAlta")%></div></td>
    <%
	}
	if(pendien != null){
		pendien.close();
