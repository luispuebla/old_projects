...
<table width="600" border="1" align="center">
  <tr> 
    <th colspan="3"> <h1>Selecciona el Proveedor Correspondiente para Modificar sus Datos: </h1></th>
  </tr>
  <tr>
  	<th width="63">&nbsp;</th>
	<th width="178">RFC</th>
	<th width="345">Nombre<br/>Proveedor</th>
  </tr>
<%
	while (rsPro.next()){
%>	 
  <tr>
    <td><div align="center">
      <input type="radio" name="rfc" value="<%= rsPro.getString("rfc")%>" >
    </div></td>
