...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		var clave = document.calform.claveProducto.value;
		if (clave.length == 0){
			alert("Debes especificar la clave del Producto");
			document.calform.claveProducto.focus();
		}
		else{
			encontro = true;
			document.calform.action ="VentasXProductoXFecha.jsp";				
		}
	}
	return encontro;
}
...
%>
<body onLoad="setFecha(); funcionFoco()">
  <h1>Escribe la clave del producto y lapso de periodo para mostrar sus ventas:</h1>
  <form name="calform" method="post" onSubmit="return OnSubmitForm()">
  <table align="center" border="0" width="300">
  	<tr>
	  <th>Clave de Producto:</th>
	  <td><div align="center"> <input type="text" name="claveProducto" size="8" maxlength="6" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) {event.returnValue = false;}; if(event.keyCode == 13){document.form1.Submit.click();}">
	    </div></td>
	</tr>
  </table>
  <br />
