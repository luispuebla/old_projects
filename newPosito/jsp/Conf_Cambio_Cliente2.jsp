...
<%
	...
	if (llenado==1){
		cliente.update_Cliente(rfc, curp, nombre, direccion, colonia, delegacion, cp, tipoCliente, credito, tiempoCredito, contacto, telefono1, telefono2, ciudad, saldoActual);
...
%>
<h1>Se actualizó el registro exitosamente</h1>
...
%>	
	<form name="form2" method="post" target="_self" action="Conf_Cambio_Cliente.jsp">
	...
	<b class="aviso">Para modificar los datos escritos previamente da click en el boton Modificar,<br /> para salir del Proceso de Alta de Cliente da Click en Regresar.</b>
		...
		<input type="hidden" name="saldo" value="<%=saldoActual%>">
...
%>		
	<form name="form3" method="post" target="_self" action="Conf_Cambio_Cliente.jsp">
