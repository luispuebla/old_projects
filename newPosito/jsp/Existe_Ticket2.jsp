...
%>	
<h1>Introduce el n&uacute;mero de el/los Ticket(s):</h1>
<form name="form1" method="post" action="Esperando_Ticket2.jsp">
...
%>
<a href="Menu_Cobros.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="132" height="41" border="0"></a> 
<%
	}
	else if(usuario.equalsIgnoreCase("Simple") && tipoE.equalsIgnoreCase("facturador")){ %>
