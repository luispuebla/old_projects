...
%>
<h1>Asignaci&oacute;n Pr&eacute;stamo a Empleado.</h1>
<form action="Dame_Monto_Prestamo.jsp" target="_self" method="post" name="form1">
<table align="center" width="600" cellpadding="0" cellspacing="0" border="1">
  <caption>
  Selecciona el Vendedor a otorgar el pr&eacute;stamo.
  </caption>
  <tr>
  	<th>Empleado:</th>
