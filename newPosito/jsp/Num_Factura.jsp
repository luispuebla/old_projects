...
<%
	...
	String formatoFac = request.getParameter("formatoFac");
...
<form name="form1" method="post" action="Conf_Num_Factura.jsp">
...
%>
	...
	<input type="hidden" name="numfacs" value="<%=ciclo%>">		
