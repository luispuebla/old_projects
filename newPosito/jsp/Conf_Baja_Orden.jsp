...
<%	
	...
	borrado = alCom.bajaOrden(cambioPrecio);
	if(borrado){%>
		<jsp:forward page="Menu_Compras.jsp" /> 
<%
	} else {
%>
		<b class="roj">Ocurrio un error al dar de Baja la Orden de Compra en la Base de Datos.<br/>Vuelva a intentarlo</b>
<%			
	}
%>
<p align="center"><a href="Escoge_Proveedor_Orden_Baja.jsp"  target="mainFrame" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)"> <img src="imagenes/Regresar1.jpg" name="regresar" width="132" height="41" border="0"></a></p>
