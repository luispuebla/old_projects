...
%>
<form name="form2" method="post" action="Inventario_Producto_Consulta.jsp">
	<h1>Escribe la clave del producto para mostrar su Existencia: </h1>
...
<h1>O bien selecciona de la siguiente lista el producto para mostrar su Existencia:</h1>
<form name="form0" method="post" action="Selecciona_Producto_Inventario_Consulta.jsp">
...
<form name="form1" method="post" action="Inventario_Producto_Consulta.jsp">
...
<p align="center"><a href="Consultas_Inventarios.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="132" height="41" border="0" align="middle"></a></p>
