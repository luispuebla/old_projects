...
<html>
<head>
<title>Confirmaci&oacute;n de modificaciones del Proveedor</title>
...
<%
	...
	int llenado = prov.valida_add(rfc, nombre, tel1);
	if(llenado == 1) {
		resultado = prov.update_Proveedor( rfc, nombre, direccion, colonia, delegacion, cp, ciudad, tel1, tel2, fax, pagina, email, vendedor, formaPago, cuentas, credito, pagoA, des1, des2, des3, idCredito);
		if(resultado){
%>
...
<% 
				...
				<p><a href="Existe_Proveedor_Cambio.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
...
<%
		...
		if (llenado == 2){
%>	
	<form name="retache" method="post" target="_self" action="Cambio_Proveedor.jsp">
	<b class="roj">Falto por llenar al menos uno de los campos obligatorios (RFC, Nombre, Telefono1)</b> <br /> <br />
		...
		<input type="hidden" name="saldoActual" value="<%=saldoActual%>">		
	<p>	<input type="submit" name="Modificar" value="Modificar"></p>
	</form>
			<p align="center"><a href="Existe_Proveedor_Cambio.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)">
			<img src="imagenes/Regresar1.jpg" name="APadres" width="132" height="41" border="0"></a></p> 
<%
		} 
%>	
