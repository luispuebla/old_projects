...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		if(calform.tipoConsul[0].checked){
			encontro = true;
			document.calform.action ="VentasXVendedorXTiempo.jsp";
		}
		else{
			var clave = document.calform.claveVendedor.value;
			if (clave.length == 0){
				alert("Debes especificar la clave del Vendedor");
...
<body onLoad="setFecha()">
  <h1>Selecciona la consulta y lapso de periodo para mostrar sus ventas:</h1>
  ...
  <table align="center" border="1" width="450">
   <caption>Consulta por:</caption>
  	<tr>	
		...
		<th colspan="2"><div align="left"> Todos los Vendedores Activos. </div></th>
    </tr>
      <tr> 
        <th><div align="center"> <input type="radio" name="tipoConsul"  value="vend" onClick="habilitaP(this.form)"></div></th>
		<th width="274"><div align="left"> Espec&iacute;fico, Clave de Vendedor: </div></th>
