...
%>
<h1>Detalle de la Orden de Trabajo Cancelada <strong># <%=clave%></strong></h1>
...
<p></p>
<p align="center"><a href="Ordenes_Trabajo_Canceladas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
