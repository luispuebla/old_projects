...
<html>
<head>
<title>Selecci&oacute;n de una Compra para su Baja</title>
...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Recepciones_Guardadas.jsp";		
		}
	}
	else{
		return false;	
...
%>
<h1>Escoge la Compra de la que deseas verificar sus recepciones:</h1>
<p></p>
...
%>
  <tr> 
  <td> <div align="center">
    <input type="radio" name="claveOrden" value="<%= rs.getString("ClaveOrden")%>" onClick="MandaSubmit(document.forms[1])">
  </div></td>
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Consulta_Recepcion.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
