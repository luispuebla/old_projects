...
<html>
<head>
<title>Modificaci&oacute;n de Producto</title>
...
<%
	...
	String invTienda = "0";
	String invAlmacen = "0";
	boolean noSelecciono = false;
	if(request.getParameter("ID_Pro") == null){
%>
		<body>
			<b class="roj">NO SELECCIONO EL PRODUCTO A MODIFICAR.</b>
			<form name="form1" action="Cambio_Productoh.jsp" method="post" target="_self">
				<input type="submit" name="Volver" value="Volver">
			</form>
<%	
	}
	else if(request.getParameter("ID_Pro").trim().equals("")){
%>
		<body>
			<b class="roj">NO SELECCIONO EL PRODUCTO A MODIFICAR.</b>
			<form name="form1" action="Cambio_Productoh.jsp" method="post" target="_self">
...
<%	
	...
	else if(!pro.existeProductoActivo(request.getParameter("ID_Pro"))){
%>
		<body>
			<b class="roj">EL PRODUCTO A MODIFICAR NO EXISTE.</b>
			<form name="form1" action="Cambio_Productoh.jsp" method="post" target="_self">
				<input type="submit" name="Volver" value="Volver">
			</form>
<%	
...
// Saco datos de mi BD.		
			...
			while (rs.next()){
				...
				invAlmacen = rs.getString("invAlmacen");
...
<form name="form1" method="post" action="Conf_Cambio_Producto.jsp">
  ...
  <caption>
  <h1>MODIFICACI&Oacute;N DE PRODUCTO<br>Clave: <%=ID_Pro%></h1>
  </caption>
  	<tr>
		<td>
		  ...
		  <caption><b class="aviso">Datos Genéricos</b></caption>
			...
			<tr>
			  ...
			  <th colspan="2">Producto Gama Reto&ntilde;o: </th>
...
%>			  
		  ...
		  <caption><b class="aviso">Datos Venta</b></caption>
		      ...
		      <td width="24%"><div align="center">
		          <select name="tipoPrecio" onChange="Habilitador(this.form)">
        		    <option <%if(tipoPrecio.equalsIgnoreCase("0") || tipoPrecio.equals("")){%> selected<%}%> value="0">Solo Base</option>
		            <option <%if(tipoPrecio.equalsIgnoreCase("1")){%> selected <%}%> value="1">Grupo de Precios</option>
        		    <option <%if(tipoPrecio.equalsIgnoreCase("2")){%> selected <%}%> value="2">Precios Escalonado</option>
		          </select>
      		  </div></td>
			  <th colspan="2">Manejo de Precio:</th>
			  <td width="22%" colspan="4"><div align="center">
	...
	<tr>
		<td>
		  ...
		  <caption><b class="aviso">Datos Inventario</b></caption>
			...
			<tr>
			  <td><div align="center"> <input name="invTienda" readonly="true" type="text" size="10" maxlength="7" value="<%=invTienda%>"onKeyPress="if (event.keyCode < 46 || event.keyCode > 57) event.returnValue = false;"><b class="roj">**</b></div></td>			  
			  <td><div align="center"> <input name="invAlmacen" readonly="true" type="text" size="10" maxlength="7" value="<%=invAlmacen%>"onKeyPress="if (event.keyCode < 46 || event.keyCode > 57) event.returnValue = false;"><b class="roj">**</b></div></td>			  
  ...
  <b class="roj">**</b> No se puede modificar.
  <p>
...
%>
<p><a href="Menu_Productos.jsp" target="mainFrame" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)"  onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="132" height="41" border="0"></a></p>
