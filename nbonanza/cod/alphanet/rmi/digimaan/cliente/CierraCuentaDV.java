...
public class CierraCuentaDV extends JInternalFrame {
	...
	private ImageIcon iiBoton1N, iiBoton1P, iiBoton2N, iiBoton2P, 	iiBoton3N, iiBoton3P, iiBoton4N, iiBoton4P, iiBoton5N, iiBoton5P,  iiBoton6N, iiBoton6P, iiBoton7N, iiBoton7P, iiBoton8N, iiBoton8P, iiBoton9N, iiBoton9P, iiBoton0N, iiBoton0P, iiBotonBN, iiBotonBP, iiBotonCanN, iiBotonCanP, iiAceptarN, iiAceptarP;
	private Sound son;
    ...
    public CierraCuentaDV() throws Exception {
        super("Cierra Cuenta", false, true, false);
	...
	public void despliegaInterfaz() throws Exception{
		...
		url= getClass().getResource("/imas/fondoCierraCuenta.jpg");
		...
		jtClaveU.setBounds(335,125,185,40);
		...
		jlAceptar.setBounds (600,240,165,70);
	...
	public void procesaVendedorCC() throws Exception{
		...
		if(claveU == 0){
			...
			if (!existe){
				...
				int resultado = 0;
				try{
					resultado = digiCliente.bs.existeCuenta(claveU);
				}
				catch(RemoteException re){
					this.setVisible(false);
					this.dispose();
