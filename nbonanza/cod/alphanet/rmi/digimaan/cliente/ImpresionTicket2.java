...
public class ImpresionTicket2 extends JInternalFrame {
    ...
    public ImpresionTicket2() throws Exception {
        super("Manda Impresión de Ticket", false, true, false);
	...
	public void despliegaInterfaz() throws Exception{
		...
		url= getClass().getResource("/imas/fondoImpresionTicket.jpg");
...
// Recibo quien procesa el ticket..
	...
	public void ProcesoImprime () throws Exception{
		...
		digiCliente.bs.ImprimeTicketACobrar(claveTicket,identificador, claveU);
	}
