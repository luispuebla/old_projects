...
*/
public class MandaRecuperaPLST{
...
*/
	public static void main (String[] args) throws Exception{
		MandaRecuperaPLST g = new MandaRecuperaPLST();
		int ciclador = 1;
		String accion;
		...
		while (ciclador ==1){
			if (accion.equalsIgnoreCase("1")){
				...
				//ManagerProductos mp = new ManagerProductos();
				//System.out.println("El nombre fue: " +mp.rfcCliente("Fernández Jaimes Enrique"));
				ciclador = 0;
			}
			else{
	...
	public void cicloIngresa() throws Exception{
		...
		consolaString();
		ParseadorPLST pplst = new ParseadorPLST();
		pplst.lectura(nombreArchivo);
	...
	public void cicloTraer() throws Exception{
		...
		lineaArchivo.append("\r\n");
		lineaArchivo.append("Swascii /iplst /o"+nombreArchivo +" plstt.if");
		lineaArchivo.append("\r\n");
	...
	public void cicloMandar() throws Exception{
		...
		BufferedWriter escritorBuff = new BufferedWriter( escritor );
		StringBuffer lineaArchivo = new StringBuffer();
		lineaArchivo.append("swascii /i"+nombreArchivo +" /oPLST plstm.if");
		lineaArchivo.append("\r\n");
