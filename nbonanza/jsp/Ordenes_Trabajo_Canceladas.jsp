...
<html>
<head>
<title>Muestra Consulta Ordenes de Trabajo Canceladas</title>
...
<%
	...
	ResultSet pendien = inv.dameOrdenesCanceladas();
%>
<p>
<h1>&Oacute;rdenes de Trabajo Canceladas</h1>
<table width="261" border="1">
  <tr> 
    <th width="87">Clave</th>
    <th width="158">Fecha de Baja </th>	
  </tr>
<% 		
	while (pendien.next()){
%>
  <tr> 
    <td><div align="center"><a href="DetalleOrdenCancelada.jsp?<%=pendien.getString("clave")%>"><%=pendien.getString("clave")%></a></div></td>
    <td><div align="center"><%=pendien.getString("fechaBaja")%></div></td>
    <%
	}
	if(pendien != null){
		pendien.close();
