...
<html>
<head>
<title>Existe de Cliente para Facturar</title>
...
%>	
<h1>Introduce el RFC del Cliente a Facturar:</h1>
<form name="form1" method="post" action="Escoge_Cliente_Fac_En.jsp" target="_self">
<table width="450" border="1" align="center">
  <tr> 
    <td colspan="3" height="45"> <div align="center">
