...
%>
<form name="form2" method="post" action="Inventario_Producto.jsp">
	<h1>Escribe la clave del producto para cambiar su existencia: </h1>
...
<h1>O bien seleccione de la siguiente lista el producto para su cambio de existencia:</h1>
<form name="form0" method="post" action="Selecciona_Producto_Inventario.jsp">
