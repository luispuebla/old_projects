...
<jsp:useBean id="prov" class="com.alpha.bd.ManagerProveedores" />
...
<%
	...
	found = prov.existe(rfc);
 	if(!found) {
%>
	<b class="roj">No tengo ning&uacute;n proveedor con RFC: <%=rfc%> registrado en Sistema.</b>
<%
	  } 
	  if(found){
...
<% 
		...
		<b class="roj">¡No se pudo realizar la baja!, <br /> vuelva a intentarlo</b>		
<%		}
	}	
%>
