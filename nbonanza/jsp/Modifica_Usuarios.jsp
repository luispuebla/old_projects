...
<html>
<head>
<title>Modificaci&oacute;n Datos/Permiso de Vendedor</title>
...
function OnSubmitForm(){
	...
	document.form1.action ="Conf_Mod_Usuario.jsp";		
	return true;	
}
...
<%	
	String claveU = request.getParameter("claveU");
	String nombre = "";
	String permiso = "";
	String contraPCD = "";
	String contraPCD2 = "";
	...
	String telCel = "";
	String observacion = "";	
	if(!usuario.existe2(claveU) || claveU.trim().equals("")){
%>
	<form name="regreso" target="_self" method="post" action="Dame_ClaveUsuario.jsp">
		<b class="roj">El usuario con la clave: <%=claveU%>, no existe o fue dado de baja.</b>
...
<%			
		...
		if(request.getParameter("interino") != null){
			claveU = request.getParameter("claveU");
			...
			ResultSet rs = usuario.dameUsuario(claveU);
			while (rs.next()){
				nombre = rs.getString("NombreE");
				permiso = rs.getString("permisoCobro");
				salario = usuario.formatoDinero(rs.getString("salario"));
				contraPCD = rs.getString("clavePermiso");
				contraPCD2 = rs.getString("clavePermiso");
				direccion = rs.getString("direccion");
				telCasa = rs.getString("telCasa");
...
%>	
	...
	<p>Modifica los datos/permiso.</p>
<%
%>
<form name="form1" method="post" onSubmit="return OnSubmitForm();">
  <input type="hidden" name="claveU" value="<%=claveU%>">
  <table width="750" border="1">
    <tr> 
      <th width="182">Nombre del Vendedor:<br> <font size="2">(A.Paterno A.Materno Nombre(s))</font></th>
      <td width="552"> <div align="center"> <input name="nombre" type="text" size="60" maxlength="50" value="<%=nombre%>" onFocus="seleccionaTodo(this)"> 
	...
	<tr>
	  ...
	  <td><div align="center">
	  <input name="contraPCD" onFocus="seleccionaTodo(this)" value="<%=contraPCD%>" type="password"  size="6" maxlength="4" onKeyPress="if (event.keyCode < 46 || event.keyCode > 57) event.returnValue = false;">	
	...
	<tr>
	  ...
	  <td><div align="center">
	  <input name="contraPCD2" onFocus="seleccionaTodo(this)" type="password" size="6" maxlength="4" value="<%=contraPCD2%>" onKeyPress="if (event.keyCode < 46 || event.keyCode > 57) event.returnValue = false;">	  
	     <span class="style1">++</span><br /> 
	    <font size="1">* Númerico</font></div></td>
	</tr>	
	<tr>
	  <th>Salario Semanal:</th>
	  <td><div align="center">$ <input onFocus="seleccionaTodo(this)" name="salario" type="text" size="10" maxlength="8" align="right" value="<%=salario%>"  onKeyPress="if (event.keyCode < 46 || event.keyCode > 57) event.returnValue = false;"></div></td>
	</tr>	
	</tr>	
...
<%	} %>	
<p><a href="Menu_Vendedores.jsp" target="mainFrame" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="imagenes/Regresar1.jpg" name="regresar" width="132" height="41" border="0"></a></p>	
