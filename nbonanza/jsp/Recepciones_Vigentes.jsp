...
function OnSubmitForm(){
	if(form1.claveABorrar != null){
		var valor = 'Ninguno';
		if(form1.claveABorrar.checked){
			valor = form1.claveABorrar.value;
		}
		for(var i=0; i<form1.claveABorrar.length; ++i){
			if(form1.claveABorrar[i].checked){
				valor = form1.claveABorrar[i].value;
			}
		}	
		if(valor == 'Ninguno'){
			alert("Debes seleccionar al menos una recepcion para proseguir.");
			return false;
		}
		else{
			document.form1.action ="Elimina_Recepciones.jsp";		
		}
	}
	else{
		return false;	
...
<table width="760" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <th width="76" height="29" scope="col">Clave</th>
    <th width="119" scope="col">Fecha</th>
	<th width="111" scope="col">Estado<br/>Recepci&oacute;n</th>	
	<th width="85" scope="col">Estado<br/>Pagos</th>	
	<th width="89" scope="col">Subtotal</th>
	<th width="89" scope="col">Descuentos</th>
	<th width="81" scope="col">I.V.A.</th>
	<th width="92" scope="col">Total</th>	
  </tr>
...
%>
	<tr> 
	<th> <input type="checkbox" name="claveABorrar" value="<%=claveRecepcion%>"> </th> 	
	<td colspan="7"><div align="left">
	  <b>Eliminar esta recepcion (<%=claveRecepcion%>)</b></div></td>
	</tr>
	<tr>
...
<p>
<a href="Escoge_Proveedor_Baja_Recepcion.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="132" height="41" border="0"></a>
</p>
