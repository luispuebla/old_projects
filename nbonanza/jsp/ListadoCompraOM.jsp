...
<%
	...
	String descuentos = request.getParameter("descuentos");
...
<form name="formaR" method="post" target="_self" action="Cambio_Orden.jsp">
	...
	<input type="hidden" name="obsequio" value="<%=queryString%>">	
...
%>	
	...
	<caption>Selecciona el producto de obsequio #<%=queryString%></caption>
	  <tr>
	  	<th>Clave</th>
		<th>Nombre</th>
...
<%		if (esporKilo) {  %>
			<td colspan="2"><input type="radio" name="rg" value="KG<%=productos.getString("ID_Pro")%>"> Por Kilo</td>
<%		} else{   
...
%>
				<td><input type="radio" name="rg" value="PZ<%=productos.getString("ID_Pro")%>"> Por Pieza</td>
				<td><input type="radio" name="rg" value="CJ<%=productos.getString("ID_Pro")%>"> Por Caja</td>
<%			} else if(soloPieza){ 	%>
				<td colspan="2"><input type="radio" name="rg" value="PZ<%=productos.getString("ID_Pro")%>"> Por Pieza</td>
<%			} else { 	%>
				<td colspan="2"><input type="radio" name="rg" value="CJ<%=productos.getString("ID_Pro")%>"> Por Caja</td>
<%			} %>
<%		} 		%>		
	</tr>
<%	
