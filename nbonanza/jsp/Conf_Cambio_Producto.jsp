...
<%
	...
	if(!codBarras1.trim().equalsIgnoreCase("")){
		validaCodigo += pro.codBarrasR(codBarras1, ID_Pro);
	}
	if(!codBarras2.trim().equalsIgnoreCase("")){	
		validaCodigo += pro.codBarrasR(codBarras2, ID_Pro);
	}
	if(!codBarras3.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras3, ID_Pro);
	}
	if(!codBarras4.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras4, ID_Pro);
	}
	if(!codBarras5.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras5, ID_Pro);
	}
	if(!codBarras6.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras6, ID_Pro);
	}
	if(!codBarras7.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras7, ID_Pro);
	}
	if(!codBarras8.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras8, ID_Pro);
	}		
	if(!codBarras9.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras9, ID_Pro);
	}	
	if(!codBarras10.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras10, ID_Pro);
	}	
	if(!codBarras11.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras11, ID_Pro);
	}	
	if(!codBarras12.trim().equalsIgnoreCase("")){		
		validaCodigo += pro.codBarrasR(codBarras12, ID_Pro);
	}	
...
%>
	<form name="regreso" target="_self" method="post" action="Modifica_Producto.jsp">
	...
	<%if(bprecioc){%> *	Se solicit&oacute; manejo por caja y falta el precio Base por caja.<br> <%}%>	
	...
	<%if(gpreciopyc){%> * Se solicit&oacute; Grupo de Precios por Pieza y Caja y falta llenar un campo de Grupo por Caja, o es igual a 0.<br> <%}%>
...
%>		
			<h1>Modificaci&oacute;n de Producto Exitosa</h1>
			<div align="center"><b class="aviso"> Clave de Producto: <%=ID_Pro%> </b></div><br/>
