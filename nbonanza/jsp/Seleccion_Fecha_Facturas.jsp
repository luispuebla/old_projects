...
<html>
<head>
<title>Consulta de Compras por Fechas</title>
...
%>	
<h1>Selecciona el peri&oacute;do de tiempo para buscar <br/>Compras que fueron Registradas en ese lapso: </h1>
<form name="form1" method="post" action="Determina_Tipo_Consulta_Factura.jsp">
  <div align="center">
    <table width="200">
      <tr> 
        <td> 
