...
%>
<form name="form2" method="post" action="Modifica_Producto.jsp">
	<h1>Escribe la clave del producto para su modificaci&oacute;n: </h1>
...
<h1>O bien seleccione de la siguiente lista el producto para su modificaci&oacute;n:</h1>
<form name="form0" method="post" action="Cambio_Productoh.jsp">
...
<form name="form1" method="post" action="Modifica_Producto.jsp">
...
<p align="center"><a href="Menu_Productos.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="132" height="41" border="0" align="middle"></a></p>
