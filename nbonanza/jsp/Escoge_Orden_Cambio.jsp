...
<html>
<head>
<title>Selección de una Compra para su Cambio</title>
...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Cambio_Orden.jsp";		
		}
	}
	else{
		return false;	
...
<% if(proveedor == null){%>
	<b class="roj">Debes seleccionar un proveedor para modificar la venta</b>
<% } else{ %>
 <jsp:setProperty name="alCom" property="claveProveedor" value="<%=proveedor%>"/>
<h1>Escoge la Compra que deseas Cambiar:</h1>
<p></p>
<form name="form1" method="post" onSubmit="return OnSubmitForm();">
<input type="hidden" name="proveedorC" value="<%= proveedor%>" >
<input type="hidden" name="inicio" value="">
 <table width="520" border="1" align="center">
  <caption>
  COMPRAS SIN FINALIZAR
  </caption>
  <tr> 
    <td width="35"><div align="center"> <input type="radio" name="claveOrden"  readonly="true" disabled> </div> </td>
...
<%
	ResultSet rs = alCom.todasLasOrdenesXProveedores2();
	while(rs.next()){
%>
  <tr> 
  <td width="35"> <div align="center">
    ...
    <td width="92"><div align="center"><%=rs.getString("ClaveOrden")%></div></td>
    <td width="240"><div align="center"><%=rs.getString("fechaRegistro")%></div></td>
    <td width="125"><div align="right">$ <%=alCom.formatoDinero(rs.getString("total"))%></div></td>
  </tr>
<%
	}
	if(rs != null){
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Orden_Cambio.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
