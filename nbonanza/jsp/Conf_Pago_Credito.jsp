...
<%
	...
	double total1 = credito.cambiaADouble(pago);
	...
	String dias = request.getParameter("diasAPagar");		
...
<%		
		...
		int resultado = credito.daTicketACredito(fecha, ticket1, ticket2, ticket3, ticket4, ticket5, pago1, pago2, pago3, pago4, pago5, nombre, rfc, dias, usuario);
		if(resultado == 0){
%>
<form name="form1" method="post" target="_blank" action="Ticket_Credito.jsp" >
	...
	<input name="pago" type="hidden" value="<%=pago %>">
	...
	<input type="hidden" name="fechaPago" value="<%=credito.fechaPago %>">	
