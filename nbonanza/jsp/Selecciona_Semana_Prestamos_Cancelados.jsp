...
<html>
<head>
<title>Selecciona Semana Prestamos Cancelados</title>
...
%>
<h1>El año y semana para desplegar los pr&eacute;stamos monetarios cancelados:</h1>
<form action="Selecciona_Semana_Prestamos_Cancelados.jsp" target="_self" method="post" name="form1">
<table align="center" width="600" cellpadding="0" cellspacing="0" border="1">
  <caption>
    Selecciona a&ntilde;o y Semana para mostrar Todos los pr&eacute;stamos que se cancelaron:
  </caption>
  <tr>
...
<form action="Muetra_Prestamos_Cancelados_Semana.jsp" target="_self" method="post" name="form2">
<table align="center" width="600" cellpadding="0" cellspacing="0" border="1">
  <tr>
