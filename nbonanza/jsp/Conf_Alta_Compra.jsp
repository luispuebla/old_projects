...
%>
	...
	<form name="retache" method="post" target="_self" action="Alta_Compra.jsp" >
...
<%	
		...
		while(rsProv.next()){
			...
			des1BD = rsProv.getDouble("descuento1");
			des2BD = rsProv.getDouble("descuento2");
			des3BD = rsProv.getDouble("descuento3");
...
<% 		} %>	
	...
	<table align="center" border="1" width="700" cellpadding="0" cellspacing="0">
		...
		<% if(tienesCredito){ %>
			<td><div align="right"><b>$ <%=alCom.formatoDinero(saldoDisponible+"")%> &nbsp;</b></div></td>
		<% } else { %>
		...
		<% } %>
			<td>
				<table cellpadding="0" cellspacing="0" width="100%" border="1">
					<tr>
						<td  width="8%" rowspan="2"><div align="center"> <input type="radio" name="rg" value="1" checked onClick="verificaPermisos()"> </div></td>
					...
					<tr>
						<td rowspan="2"><div align="center"> <input type="radio" name="rg" value="2" onClick="verificaPermisos()"> </div></td>
						<td rowspan="2" height="40"><div align="left">Recepción Programada</div></td>
					  <td rowspan="2" colspan="2"><div align="center"> <input type=text name="datebox" size=15 readonly="true" value="<%=fechaHoy%>"> <a href="javascript:show_calendar('form1.datebox');" onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;"><img src="imagenes/show-calendar.gif" width=30 height=26 border=0 align="absmiddle"></a></div></td>
					</tr>
				</table>
			</td>
		</tr>
...
<form name="retache2" method="post" target="_self" action="Alta_Compra.jsp">
		<input type="hidden" name="prodRegalo1" value="<%=prodRegalo1%>">
		<input type="hidden" name="prodRegalo2" value="<%=prodRegalo2%>">
		<input type="hidden" name="prodRegalo3" value="<%=prodRegalo3%>">
		<input type="hidden" name="tipoUniRegalo1" value="<%=tipoUniRegalo1%>">
