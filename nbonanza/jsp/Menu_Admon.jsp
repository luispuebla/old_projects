...
<p align="center"><img src="imagenes/MenuPrincipal.jpg" width="700" height="400" border="0" usemap="#Map"> 
  <map name="Map">
    ...
    <area shape="poly" coords="500,314,582,314,602,225,485,225" href="Menu_Ventas.jsp" target="_self">
    ...
    <area shape="rect" coords="299,11,420,91" href="Menu_Compras.jsp" target="_self">
    <area shape="poly" coords="99,311,208,311,208,278,190,278,190,227,118,227,118,278,99,278" href="Menu_Vendedores.jsp" target="_self">
