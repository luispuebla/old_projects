...
%>
	...
	<form name="form1" method="post" action="Existe_Ticket_Cred_Vend.jsp">
...
%>
	 <jsp:forward page="PagoCreditoVendedor.jsp" > 
		<jsp:param name="vendedor" value="<%=vendedor %>" />
...
%>
	<form name="form2" method="post" action="Existe_Ticket_Cred_Vend.jsp">
		<input type="hidden" name="vendedor" value="<%=vendedor%>">
		<p>	<input name="Regresar" type="submit" id="Regresar" value="Volver"></p>
	</form>
<%
