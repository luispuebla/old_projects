...
<html>
<head>
<title>Consulta de por Fechas Venta Productos</title>
...
%>
<h1>Selecciona el peri&oacute;do de tiempo para mostrar los Productos Vendidos</h1>
<form name="form1" method="post" action="Productos_Vendidos_Fecha.jsp">
  <div align="center">
    <table width="200">
      <tr> 
