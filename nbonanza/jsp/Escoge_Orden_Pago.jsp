...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Pago_Compra.jsp";		
		}
	}
	else{
		return false;	
...
%>
  	  <tr> 
  		<td> <div align="center"> <input type="radio" name="claveOrden" value="<%= laClave%>" onClick="MandaSubmit(document.forms[0])"> </div></td>
	    <td><div align="center"><%=laClave%></div></td>
	    <td><div align="center"><%=laFecha%></div></td>
	    <td><div align="center"><%=elDocumento%></div></td>		
    	<td><div align="right">$ <%=elTotal%></div></td>
	  </tr>
<%			
			laClave = rs.getString("ClaveOrden");
			laFecha = rs.getString("fechaRegistro");
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Pago.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
