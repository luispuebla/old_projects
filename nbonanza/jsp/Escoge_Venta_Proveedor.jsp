...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Recepciones_Vigentes.jsp";		
		}
	}
	else{
		return false;	
...
%>
<h1>Escoge la Compra sin finalizar a la que corresponde  la Recepción a dar de Baja:</h1>
<p></p>
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Baja_Recepcion.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
