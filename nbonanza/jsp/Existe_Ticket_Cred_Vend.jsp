...
<html>
<head>
<title>Existencia de Ticket</title>
...
%>	
<h1>Introduce el n&uacute;mero de el/los Ticket(s)<br/>que ser&aacute;n dados a Cr&eacute;dito al Vendedor:<br/> >> <b><%=empleado.dameNombreUsuario(vendedor)%></b> <<</h1>
<form name="form1" method="post" action="Esperando_Ticket_Cred_Vend.jsp">
<input type="hidden" name="vendedor" value="<%=vendedor%>">
<table width="400" border="1" align="center" cellspacing="0">
  <tr>
	<th width="46%">Fecha: </th>
...
<p align="center">
<a href="Menu_Credito.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regreso','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regreso" width="132" height="41" border="0"></a> 
</p>
