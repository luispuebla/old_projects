...
<jsp:useBean id="av" class="com.alpha.bd.ManagerTicket" scope="page" />

<html>
<head>
<title>Guarda Aviso Ticket</title>
...
<table width="500" border="0" align="center">
  <tr> 
    <td>  
		...
		//System.out.println("Llego: "+aviso);
		boolean salio = true;
		salio = av.CambiaAviso(aviso);
		if(salio){ %>
			<jsp:forward page="Menu_Contras_Texto.jsp" />
		<%}
		else{ %>
			<b class="roj">Surgio un problema al momento de Guardar el Aviso </b>
		<%}
%>		
