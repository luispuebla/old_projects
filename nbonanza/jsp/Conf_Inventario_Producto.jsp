...
<%
	...
	String existenciaOriT = request.getParameter("existenciaOriT");
	String invAlmacen = request.getParameter("invAlmacen");
	String existenciaOriA = request.getParameter("existenciaOriA");
	String causa = request.getParameter("causa");
	
	int resultado = 0;
	resultado = inv.update_Producto_Inventario(elProducto, existenciaOriT, invTienda, existenciaOriA, invAlmacen, usuario, causa);
	if(resultado == 1){
%>
...
<input type="hidden" name="ID_Pro" value="<%=elProducto%>">
