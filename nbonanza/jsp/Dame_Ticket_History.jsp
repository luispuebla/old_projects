...
<html>
<head>
<title>Recoplia Ticket Venta</title>
...
<form name="form1" method="post" action="Muestra_Historia_Ticket.jsp" target="_self">
<table align="center" width="350" cellpadding="0" cellspacing="0" border="1">
<caption>
Introduce el N&uacute;mero de Ticket para Mostrar su Historial
</caption>
  <tr>
  	<th>Ticket:</th>
	<td><div align="center">
	  <input type="text" name="ticket" maxlength="10" size="15">
	  </div></td>
  </tr>
</table>
