...
<title>Guardar Modificaci&oacute;n Compra</title>
...
String exito = alCom.update_Orden_Compra(usuario);
if(exito.equalsIgnoreCase("OK")){	%>
<table align="center" border="0" width="600">
<caption>
Se modific&oacute; satisfactoriamente la Transacci&oacute;n.
</caption>
  <tr>
  	<td><div align="center"><b>Clave de Compra:</b></div></td>
  </tr>
  <tr>
	<th height="50"><b class="titulos"><%=claveOrden%></b></th>
  </tr>		
<% if(recepcion.equals("1")){  %>
  <tr>
...
<% } %>  
  <tr>	
	<td height="35"><form method="post" target="_blank" name="RegN" action="Imprimir_Compra.jsp">
		<div align="center">
		  <input type="hidden" name="claveCompra" value="<%=claveOrden%>">
...
<% 	}	
	...
	else if(exito.equalsIgnoreCase("Error")){ %><br/>
<b class="roj">No se pudo concretar la transacci&oacute;n de Modificar Compra.<br/>Vuelva a intentarlo.</b>
<% } else{
%>
<b class="roj">No se pudo concretar la transacci&oacute;n de Modificar Compra.<br/>Se produjo el siguiente error:</b>
<p align="center"><%=exito%></p>
<%	}
%>
