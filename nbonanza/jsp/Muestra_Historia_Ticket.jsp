...
<%	String ticket = request.getParameter("ticket");
	if(mticket.cambiaAInt(ticket) == 0){ %>
		<p><b class="roj">Debes escribir el n&uacute;mero del Ticket.</b></p>
<%	}
	else{ 
		boolean existeTicket = false;
		existeTicket = mticket.existeElTicket(ticket);
		if(!existeTicket){ %>
			<b class="roj">El Ticket #<%=ticket%> no existe en el Sistema,<br/>No hay ningún registro de él.</b>						
<%		}		
		else { 
