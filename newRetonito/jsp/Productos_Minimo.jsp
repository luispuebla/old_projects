...
<html>
<head>
<title>Productos con el M&iacute;nimo</title>
...
<%
	...
	ResultSet minimo = inv.dame_Minimo();
%>
<p>
<table width="750" border="1">
<caption>
Productos con Existencia igual o menor al M&iacute;nimo especificado.
</caption>
  <tr> 
    <th width="65" rowspan="2">Clave</th>
    <th width="280" rowspan="2">Producto</th>
    <th width="70" rowspan="2">Tipo</th>
    <th width="85" rowspan="2">M&iacute;nimo</th>
...
<% 
		...
		String invTienda = minimo.getInt("invTienda")+"";
		String invAlmacen = minimo.getInt("invAlmacen")+"";
		String inventario = minimo.getInt("inventario")+"";
		String elMinimo = minimo.getInt("minInv")+"";
		if (minimo.getInt("tipoPro") == 1){
			tipoP = "Kg.";
			invTienda = minimo.getDouble("invTienda")+"";
			invAlmacen = minimo.getDouble("invAlmacen")+"";
			inventario = minimo.getDouble("inventario")+"";
			elMinimo = minimo.getDouble("minInv")+"";			
		}
%>
  <tr> 
    <td><div align="center"><%=minimo.getString("ID_Pro")%></div></td>
    <td><div align="center"><%=minimo.getString("descripcion")%></div></td>
    <td><div align="center"><%=tipoP%></div></td>
    <td><b><div align="center"><%=elMinimo%></div></b></td>	
