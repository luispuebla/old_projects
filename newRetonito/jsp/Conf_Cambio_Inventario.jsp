...
<%
	...
	String[] invAnteriorT = (String[])request.getParameterValues("invTienda");
	String[] invTienda = (String[])request.getParameterValues("nuevaT");
	String[] invAnteriorA = (String[])request.getParameterValues("invAlmacen");
	String[] invAlmacen = (String[])request.getParameterValues("nuevaA");
	String causa = request.getParameter("causa");
	int todobien = 0;
	todobien = inv.update_Inventarios(clavetodos, invTienda, invAnteriorT, invAlmacen, invAnteriorA, usuario, causa);
	if(todobien == 0){
%>
...
<b class="roj">Existió una transacci&oacute;n que modific&oacute; paralelamente el Inventario.<br/></b>
<b class="roj">Vuelva a introducir sus cambios para el Inventario.</b>
<form name="retache" method="post" target="_self" action="Modificacion_Inventario_Todos.jsp">
