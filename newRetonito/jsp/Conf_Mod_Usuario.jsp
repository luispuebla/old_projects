...
<html>
<head>
<title>Vendedor Modificado</title>
...
%>	
	...
	<form name="regreso" target="_self" method="post" action="Modifica_Usuarios.jsp">
...
%>
	...
	<form name="retache" target="_self" action="Modifica_Usuarios.jsp" method="post">
		<input type="hidden" name="claveU" value="<%=claveU%>">
		<input type="hidden" name="nombre" value="<%=nombre%>">
		<input type="hidden" name="permiso" value="<%=permiso%>">
		<input type="hidden" name="salario" value="<%=salario%>">
...
<%	
		...
		boolean exito = usuario.actualizaUser(claveU, nombre, permiso, claveP, salario, direccion, telCasa, telCel, observacion);
		if(exito){
%>		
		<h1>Se modific&oacute; el registro exitosamente</h1>
<table width="457" border="1" align="center">
  <tr> 
    <th width="185" bgcolor="#CCCCCC">Nombre del Vendedor:</th>
    <td width="256"> <div align="center"><%=nombre%> </div></td>
  </tr>
  <tr> 
    <th bgcolor="#CCCCCC">Clave de Acceso:</th>
    <td> <div align="center"><%= claveU %> </div></td>
  </tr>  
</table>
<%			
	}
...
%>
			<b class="roj">Existi&oacute; un problema con la Base de Datos, no se pudo almacenar el vendedor.</b>
<%} %>

<%}%>
<p><a href="Menu_Vendedores.jsp" target="mainFrame" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('APadres','','imagenes/Regresar2.jpg',1)"> <img src="imagenes/Regresar1.jpg" name="APadres" width="132" height="41" border="0"></a></p> 	
