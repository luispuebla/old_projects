...
<html>
<head>
<title>Confirma Baja de Ticket</title>
...
<%
	...
	String numTicket = request.getParameter("ticket1");
	String tipo = request.getParameter("tipo");
	String user = "";
	boolean exito = false;
	user = ticket.dameUsuarioQueCobro(numTicket);
	// TICKET PAGADO AL CONTADO...
	if(tipo.equalsIgnoreCase("1")){
		// CAMBIO ESTATUS DEL TICKET A 0 (NO PAGADO)
		exito = ticket.cancelaTicket(numTicket, user);
		if(exito){
%>		
		  <div align="center">
			<b class="aviso">¡La Cancelación del Ticket fue Exitosa!</b>
  	      </div>
<%		} else{ %>
		<div align="center">
			<b class="roj">Sucedio un problema al momento de Cancelar al Ticket</b>
		</div>
<%		
		}
	}
	else if (tipo.equalsIgnoreCase("2")){
		exito = credito.cancelaTicket(numTicket, user);
		if(exito){
%>		
		  <div align="center">
			<b class="aviso">¡La Cancelación del Ticket fue Exitosa!</b>
