<%@ page language="java" import="java.sql.*, java.io.*, java.util.*, java.math.*" session = "true" errorPage=""%>
...
<%			}
				...
				ResultSet rs = factura.dameListadoTicketsFac(ticket1, ticket2, ticket3, ticket4, ticket5, formatoFac);			
				for(int i=0; i<ArrayFactura.length; i++){
