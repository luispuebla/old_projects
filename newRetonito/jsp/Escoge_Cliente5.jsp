...
function OnSubmitForm(){
	if(form1.nombre != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Solicitud_Factura.jsp";		
		}
	}
	else{
		return false;	
...
%>	
<p><a href="Existe_Cliente.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('regresar','','imagenes/Regresar2.jpg',1)">
