...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="PagosXCompra.jsp";		
		}
	}
	else{
		return false;	
...
<h1>Escoge la Compra para desplegar el/los Pago(s) correspondientes:</h1>
<p></p>
...
<input type="hidden" name="proveedor" value="<%=proveedor%>">
 <table width="520" border="1" align="center">
  ...
  <tr> 
    <td width="22"><div align="center"> <input type="radio" name="claveOrden"  readonly="true" disabled> </div> </td>
    <th width="77">Clave</th>
	<th width="128">Fecha en la que se Realizo</th>
	<th width="266">Documento(s) Aval(es)</th>
    <th width="123">Total</th>
   </tr>
<%
...
%>
    	...
    	<td width="123"><div align="right">$ <%=elTotal%></div></td>
	  </tr>
<%			
			laClave = rs.getString("ClaveOrden");
			laFecha = rs.getString("fechaRegistro");
