...
<html>
<head>
<title>Selecci&oacute;n de Periodo Facturas</title>
...
function OnSubmitForm(){
	...
	if(fecha > fecha2){
		...
		encontro = true;
		document.calform.action ="Facturas_Compras_Tiempo.jsp";				
	}
	return encontro;
}
...
<body onLoad="setFecha()">
  ...
  facturas de los proveedores dentro de este rango:<br /></h1>
