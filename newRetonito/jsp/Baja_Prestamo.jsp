...
<html>
<head>
<title>Baja de  Pr&eacute;stamo</title>
...
<%
	boolean eliminacion = empleado.bajaPrestamo(claveOrden, usuario);
	if(eliminacion){ %>
		<jsp:forward page="Menu_Prestamos_Nominas.jsp" />
<%	}
	else { %>
		<b class="roj">No se pudo eliminar la entrada del pr&eacute;stamo.., vuelva a intentarlo.</b>
<% 	} %>	
