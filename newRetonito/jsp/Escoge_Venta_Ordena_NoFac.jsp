...
%>
<h1>Escoge la Compra para ordenar sus notas / facturas:</h1>
<p></p>
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Ordenamiento_NoFac.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
