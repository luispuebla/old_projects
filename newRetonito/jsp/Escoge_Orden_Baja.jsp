...
function OnSubmitForm(){
	if(form1.claveOrden != null){
		...
		if(valor == 'Ninguno'){
			...
			document.form1.action ="Baja_Orden.jsp";		
		}
	}
	else{
		return false;	
...
<%  } else{  %>
<jsp:setProperty name="alCom" property="claveProveedor" value="<%=clave%>"/>
...
<%
	ResultSet rs = alCom.todasLasOrdenesXProveedores();
	while(rs.next()){
%>
  <tr> 
  <td> <div align="center"> <input type="radio" name="claveOrden" value="<%= rs.getString("ClaveOrden")%>" onClick="MandaSubmit(document.forms[1])"> </div></td>
...
<%}%>
<p align="center"><a href="Escoge_Proveedor_Orden_Baja.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
