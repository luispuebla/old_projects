...
<html>
<head>
<title>Selecciona Semana N&oacute;mina</title>
...
%>
<h1>Selecciona el a&ntilde;o y semana para calcular la n&oacute;mina correspondiente: </h1>
<form action="Selecciona_Semana_Pago_Nomina.jsp" target="_self" method="post" name="form1">
...
<form action="Muestra_Nomina_Semana.jsp" target="_self" method="post" name="form2">
<table align="center" width="600" cellpadding="0" cellspacing="0" border="1">
  <tr>
