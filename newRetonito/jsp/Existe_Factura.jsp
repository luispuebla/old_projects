...
<% } %>
<h1>Introduce el Número de Factura a dar de baja,<br /> si pertenece a una Factura en serie,<br /> escribe únicamente una de las Facturas:</h1>
<form name="form1" method="post" action="Baja_Factura.jsp">
<table width="350" border="0" align="center" >
  <tr> 
    <td height="50"> <div align="center"><input type="text" name="factura" align="middle" size="12" maxlength="10"></div> </td>
  </tr>
</table>
<p align="center">
