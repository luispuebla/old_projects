...
<html>
<head>
<title>Consulta de por Fechas Facturas</title>
...
<h1>Selecciona el peri&oacute;do de tiempo para mostrar las Facturas Generadas, <br/>
de acuerdo con su Fecha de Emisión.</h1>
<form name="form1" method="post" action="TodasFac.jsp">
  <div align="center">
    <table width="200">
      <tr> 
...
<p align="center"><a href="Menu_Consul_Estadisticas.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Retache','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Retache" width="132" height="41" border="0"></a></p>
