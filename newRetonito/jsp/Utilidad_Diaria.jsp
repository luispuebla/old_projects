...
<h1>Utilidad Registrada para la Fecha: <br/>
<%
...
%>
 <%=mes%> /<%=anio%>: </h1>
<%	
	String utilidadHoy = ticket.dameUtilidad(fecha);
%>
<table align="center" width="300" border="1" cellpadding="0" cellspacing="0">
	<tr>
		<th width="271">Utilidad</th>
		<td width="227"><div align="right"><b>$ <%=utilidadHoy%></b></div></td>
	</tr>
</table>
