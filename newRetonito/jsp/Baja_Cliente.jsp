...
<form name="form1" method="post" action="Conf_Baja_Cliente.jsp">
...
%>
		 ...
		 <td><div align="center"> <input type="radio" name="nombre" value="<%= rs.getString("nombre") %>"> </div></td>
	      <td width="90%"> <input type="text" name="nombr" value="<%= rs.getString("nombre") %>" readonly="true" size="50" > 
			  <input type="hidden" name="rfc" value="<%=rfc%>"></td>
		  </tr>
<% 	
	} 
...
<p align="center"><a href="Existe_Cliente_Baja.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Regresar','','imagenes/Regresar2.jpg',1)"><img src="imagenes/Regresar1.jpg" name="Regresar" width="132" height="41" border="0"></a></p>
